...
var KTDashboard = function() {
    ...
    var activitiesChart = function() {
        ...
        var gradient = ctx.createLinearGradient(0, 0, 0, 240);
        gradient.addColorStop(0, Chart.helpers.color('#f8ba11').alpha(1).rgbString());
        gradient.addColorStop(1, Chart.helpers.color('#f8ba11').alpha(0.3).rgbString());
        ...
        var config = {
            ...
            data: {
                ...
                datasets: [{
                    label: "Sales Stats",
                    backgroundColor: Chart.helpers.color('#f8ba11').alpha(1).rgbString(),  //gradient
                    borderColor: '#ffdb7a',
