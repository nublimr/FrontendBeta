            ...
            <div>
                <div className="kt-grid kt-grid--hor kt-grid--root">
                    <div className="kt-grid__item kt-grid__item--fluid kt-grid kt-grid--ver kt-page">
                        {/* begin:: Aside */}
                        <button className="kt-aside-close " id="kt_aside_close_btn"><i
                                ...
                                <div id="kt_aside_menu" className="kt-aside-menu " data-ktmenu-vertical={1}
                                    ...
                                    <ul className="kt-menu__nav ">
                                        <li className="kt-menu__item  kt-menu__item--active" aria-haspopup="true"><a
                                                href="demo1/index.html" className="kt-menu__link "><span
                                        ...
                                        <li className="kt-menu__item  kt-menu__item--submenu" aria-haspopup="true"
                                            data-ktmenu-submenu-toggle="hover"><a href="javascript:;"
                                                className="kt-menu__link kt-menu__toggle"><span
                                                    ...
                                                    className="kt-menu__ver-arrow la la-angle-right" /></a>
                                                ...
                                                <ul className="kt-menu__subnav">
                                                    <li className="kt-menu__item  kt-menu__item--parent"
                                                        aria-haspopup="true"><span className="kt-menu__link"><span
                                                                className="kt-menu__link-text">Applications</span></span>
                                                    </li>
                                                    <li className="kt-menu__item  kt-menu__item--submenu"
                                                        aria-haspopup="true" data-ktmenu-submenu-toggle="hover"><a
                                                            ...
                                                            className="kt-menu__link kt-menu__toggle"><i
                                                                className="kt-menu__link-bullet kt-menu__link-bullet--line"><span /></i><span
                                                            ...
                                                            <ul className="kt-menu__subnav">
                                                                <li className="kt-menu__item " aria-haspopup="true"><a
                                                                        ...
                                                                        className="kt-menu__link "><i
                                                                            className="kt-menu__link-bullet kt-menu__link-bullet--dot"><span /></i><span
                                                                            className="kt-menu__link-text">List -
                                                                            Default</span></a></li>
                                                                <li className="kt-menu__item " aria-haspopup="true"><a
                                                                ...
                                                                <li className="kt-menu__item " aria-haspopup="true"><a
                                                                        ...
                                                                        className="kt-menu__link "><i
                                                                            className="kt-menu__link-bullet kt-menu__link-bullet--dot"><span /></i><span
                                                                            className="kt-menu__link-text">Add
                                                                            User</span></a></li>
                                                                <li className="kt-menu__item " aria-haspopup="true"><a
                                                                        href="demo1/custom/apps/user/edit-user.html"
                                                                        className="kt-menu__link "><i
                                                                            className="kt-menu__link-bullet kt-menu__link-bullet--dot"><span /></i><span
                                                                            className="kt-menu__link-text">Edit
                                                                            User</span></a></li>
                                                                <li className="kt-menu__item  kt-menu__item--submenu"
                                                                    aria-haspopup="true"
                                                                    data-ktmenu-submenu-toggle="hover"><a
                                                                        ...
                                                                        className="kt-menu__link kt-menu__toggle"><i
                                                                            className="kt-menu__link-bullet kt-menu__link-bullet--dot"><span /></i><span
                                                                            className="kt-menu__link-text">Profile
                                                                            1</span><i
                                                                            className="kt-menu__ver-arrow la la-angle-right" /></a>
                                                                    <div className="kt-menu__submenu "><span
                                                                            className="kt-menu__arrow" />
                                                        ...
                                                        <div className="kt-menu__submenu "><span
                                                            ...
                                                            <ul className="kt-menu__subnav">
                                                                ...
                                                                <li className="kt-menu__item " aria-haspopup="true"><a
                                                                        ...
                                                                        className="kt-menu__link "><i
                                                                            className="kt-menu__link-bullet kt-menu__link-bullet--dot"><span /></i><span
                                                                            className="kt-menu__link-text">View
                                                                            Contact</span></a></li>
                                                                <li className="kt-menu__item " aria-haspopup="true"><a
                                                        ...
                                                        <div className="kt-menu__submenu "><span
                                                            ...
                                                            <ul className="kt-menu__subnav">
                                                                <li className="kt-menu__item " aria-haspopup="true"><a
                                                                        ...
                                                                        className="kt-menu__link "><i
                                                                            className="kt-menu__link-bullet kt-menu__link-bullet--dot"><span /></i><span
                                                                            className="kt-menu__link-text">Private</span></a>
                                                                </li>
                                                                <li className="kt-menu__item " aria-haspopup="true"><a
                                                                        href="demo1/custom/apps/chat/group.html"
                                                                        className="kt-menu__link "><i
                                                                            className="kt-menu__link-bullet kt-menu__link-bullet--dot"><span /></i><span
                                                                            className="kt-menu__link-text">Group</span></a>
                                                                </li>
                                                                <li className="kt-menu__item " aria-haspopup="true"><a
                                                                        href="demo1/custom/apps/chat/popup.html"
                                                                        className="kt-menu__link "><i
                                                                            className="kt-menu__link-bullet kt-menu__link-bullet--dot"><span /></i><span
                                                                            className="kt-menu__link-text">Popup</span></a>
                                                                </li>
                                                            </ul>
                                                        </div>
                                                    </li>
                                        ...
                                        <li className="kt-menu__item  kt-menu__item--submenu" aria-haspopup="true"
                                            data-ktmenu-submenu-toggle="hover"><a href="javascript:;"
                                                className="kt-menu__link kt-menu__toggle"><span
                                                    ...
                                                    </svg></span><span className="kt-menu__link-text">Pages</span><i
                                                    className="kt-menu__ver-arrow la la-angle-right" /></a>
                                            <div className="kt-menu__submenu "><span className="kt-menu__arrow" />
                                                <ul className="kt-menu__subnav">
                                                    <li className="kt-menu__item  kt-menu__item--parent"
                                                        ...
                                                        <div className="kt-menu__submenu "><span
                                                            ...
                                                            <ul className="kt-menu__subnav">
                                                                <li className="kt-menu__item " aria-haspopup="true"><a
                                                                        ...
                                                                        className="kt-menu__link "><i
                                                                            className="kt-menu__link-bullet kt-menu__link-bullet--dot"><span /></i><span
                                                                            className="kt-menu__link-text">Wizard
                                                                            1</span></a></li>
                                                                <li className="kt-menu__item " aria-haspopup="true"><a
                                                        ...
                                                        <div className="kt-menu__submenu "><span
                                                            ...
                                                            <ul className="kt-menu__subnav">
                                                                <li className="kt-menu__item " aria-haspopup="true"><a
                                                                        ...
                                                                        className="kt-menu__link "><i
                                                                            className="kt-menu__link-bullet kt-menu__link-bullet--dot"><span /></i><span
                                                                            className="kt-menu__link-text">Pricing
                                                                            Tables 1</span></a></li>
                                                                <li className="kt-menu__item " aria-haspopup="true"><a
                                                        ...
                                                        <div className="kt-menu__submenu "><span
                                                            ...
                                                            <ul className="kt-menu__subnav">
                                                                <li className="kt-menu__item " aria-haspopup="true"><a
                                                                        ...
                                                                        className="kt-menu__link "><i
                                                                            className="kt-menu__link-bullet kt-menu__link-bullet--dot"><span /></i><span
                                                                            className="kt-menu__link-text">Invoice
                                                                            1</span></a></li>
                                                                <li className="kt-menu__item " aria-haspopup="true"><a
                                                        ...
                                                        <div className="kt-menu__submenu "><span
                                                            ...
                                                            <ul className="kt-menu__subnav">
                                                                <li className="kt-menu__item " aria-haspopup="true"><a
                                                                        ...
                                                                        className="kt-menu__link "><i
                                                                            className="kt-menu__link-bullet kt-menu__link-bullet--dot"><span /></i><span
                                                                            className="kt-menu__link-text">FAQ
                                                                            1</span></a></li>
                                                            </ul>
                                                        </div>
                                                    </li>
                                                        ...
                                                        <div className="kt-menu__submenu "><span
                                                            ...
                                                            <ul className="kt-menu__subnav">
                                                                <li className="kt-menu__item " aria-haspopup="true"><a
                                                                        ...
                                                                        className="kt-menu__link "><i
                                                                            className="kt-menu__link-bullet kt-menu__link-bullet--dot"><span /></i><span
                                                                            className="kt-menu__link-text">Login
                                                                            1</span></a></li>
                                                                <li className="kt-menu__item " aria-haspopup="true"><a
                                                        ...
                                                        <div className="kt-menu__submenu "><span
                                                            ...
                                                            <ul className="kt-menu__subnav">
                                                                <li className="kt-menu__item " aria-haspopup="true"><a
                                                                        ...
                                                                        className="kt-menu__link "><i
                                                                            className="kt-menu__link-bullet kt-menu__link-bullet--dot"><span /></i><span
                                                                            className="kt-menu__link-text">Error
                                                                            1</span></a></li>
                                                                <li className="kt-menu__item " aria-haspopup="true"><a
                                        ...
                                        <li className="kt-menu__item  kt-menu__item--submenu" aria-haspopup="true"
                                            ...
                                            <div className="kt-menu__submenu "><span className="kt-menu__arrow" />
                                                <ul className="kt-menu__subnav">
                                                    <li className="kt-menu__item  kt-menu__item--parent"
                                                        aria-haspopup="true"><span className="kt-menu__link"><span
                                                                className="kt-menu__link-text">Subheaders</span></span>
                                                    </li>
                                                    <li className="kt-menu__item " aria-haspopup="true"><a
                                                            href="demo1/layout/subheader/toolbar.html"
                                                            className="kt-menu__link "><i
                                                                className="kt-menu__link-bullet kt-menu__link-bullet--dot"><span /></i><span
                                                                className="kt-menu__link-text">Toolbar Nav</span></a>
                                                    </li>
                                                    <li className="kt-menu__item " aria-haspopup="true"><a
                                                            href="demo1/layout/subheader/actions.html"
                                                            className="kt-menu__link "><i
                                                                className="kt-menu__link-bullet kt-menu__link-bullet--dot"><span /></i><span
                                                                className="kt-menu__link-text">Actions
                                                                Buttons</span></a></li>
                                                    <li className="kt-menu__item " aria-haspopup="true"><a
                                                            href="demo1/layout/subheader/tabbed.html"
                                                            className="kt-menu__link "><i
                                                                className="kt-menu__link-bullet kt-menu__link-bullet--dot"><span /></i><span
                                                                className="kt-menu__link-text">Tabbed Nav</span></a>
                                                    </li>
                                                    <li className="kt-menu__item " aria-haspopup="true"><a
                                                            href="demo1/layout/subheader/classic.html"
                                                            className="kt-menu__link "><i
                                                                className="kt-menu__link-bullet kt-menu__link-bullet--dot"><span /></i><span
                                                                className="kt-menu__link-text">Classic</span></a></li>
                                                    <li className="kt-menu__item " aria-haspopup="true"><a
                                                            href="demo1/layout/subheader/none.html"
                                                            className="kt-menu__link "><i
                                                                className="kt-menu__link-bullet kt-menu__link-bullet--dot"><span /></i><span
                                        ...
                                        <li className="kt-menu__item  kt-menu__item--submenu" aria-haspopup="true"
                                            data-ktmenu-submenu-toggle="hover"><a href="javascript:;"
                                                className="kt-menu__link kt-menu__toggle"><span
                                                    ...
                                                    </svg></span><span className="kt-menu__link-text">General</span><i
                                                    className="kt-menu__ver-arrow la la-angle-right" /></a>
                                            <div className="kt-menu__submenu "><span className="kt-menu__arrow" />
                                                <ul className="kt-menu__subnav">
                                                    <li className="kt-menu__item  kt-menu__item--parent"
                                                        aria-haspopup="true"><span className="kt-menu__link"><span
                                                                className="kt-menu__link-text">General</span></span>
                                                    </li>
                                                    <li className="kt-menu__item " aria-haspopup="true"><a
                                                            href="demo1/layout/general/minimized-aside.html"
                                                            className="kt-menu__link "><i
                                                                className="kt-menu__link-bullet kt-menu__link-bullet--dot"><span /></i><span
                                                                className="kt-menu__link-text">Minimized
                                                                Aside</span></a></li>
                                                    <li className="kt-menu__item " aria-haspopup="true"><a
                                                            href="demo1/layout/general/no-aside.html"
                                                            className="kt-menu__link "><i
                                                                className="kt-menu__link-bullet kt-menu__link-bullet--dot"><span /></i><span
                                                                className="kt-menu__link-text">No Aside</span></a></li>
                                                    <li className="kt-menu__item " aria-haspopup="true"><a
                                                            href="demo1/layout/general/empty-page.html"
                                                            className="kt-menu__link "><i
                                                                className="kt-menu__link-bullet kt-menu__link-bullet--dot"><span /></i><span
                                                                className="kt-menu__link-text">Empty Page</span></a>
                                                    </li>
                                                    <li className="kt-menu__item " aria-haspopup="true"><a
                                                            href="demo1/layout/general/fixed-footer.html"
                                                            className="kt-menu__link "><i
                                                                className="kt-menu__link-bullet kt-menu__link-bullet--dot"><span /></i><span
                                                                className="kt-menu__link-text">Fixed Footer</span></a>
                                                    </li>
                                                    <li className="kt-menu__item " aria-haspopup="true"><a
                                                            href="demo1/layout/general/no-header-menu.html"
                                                            className="kt-menu__link "><i
                                                                className="kt-menu__link-bullet kt-menu__link-bullet--dot"><span /></i><span
                                                                className="kt-menu__link-text">No Header Menu</span></a>
                                                    </li>
                                                </ul>
                                            </div>
                                        </li>
                                        <li className="kt-menu__item " aria-haspopup="true"><a target="_blank"
                                                ...
                                                className="kt-menu__link "><span className="kt-menu__link-icon"><svg
                                                    ...
                                                    </svg></span><span className="kt-menu__link-text">Builder</span></a>
                                        </li>
                                        <li className="kt-menu__section ">
                                        ...
                                        <li className="kt-menu__item  kt-menu__item--submenu" aria-haspopup="true"
                                            data-ktmenu-submenu-toggle="hover"><a href="javascript:;"
                                                className="kt-menu__link kt-menu__toggle"><span
                                                    ...
                                                    </svg></span><span className="kt-menu__link-text">Base</span><i
                                                    className="kt-menu__ver-arrow la la-angle-right" /></a>
                                            <div className="kt-menu__submenu "><span className="kt-menu__arrow" />
                                                <ul className="kt-menu__subnav">
                                                    <li className="kt-menu__item  kt-menu__item--parent"
                                                    ...
                                                    <li className="kt-menu__item " aria-haspopup="true"><a
                                                            href="demo1/components/base/colors.html"
                                                            className="kt-menu__link "><i
                                                                className="kt-menu__link-bullet kt-menu__link-bullet--dot"><span /></i><span
                                                                className="kt-menu__link-text">State Colors</span></a>
                                                    </li>
                                                    <li className="kt-menu__item " aria-haspopup="true"><a
                                                            href="demo1/components/base/typography.html"
                                                            className="kt-menu__link "><i
                                                                className="kt-menu__link-bullet kt-menu__link-bullet--dot"><span /></i><span
                                                                className="kt-menu__link-text">Typography</span></a>
                                                    </li>
                                                    <li className="kt-menu__item " aria-haspopup="true"><a
                                                            href="demo1/components/base/buttons.html"
                                                            className="kt-menu__link "><i
                                                                className="kt-menu__link-bullet kt-menu__link-bullet--dot"><span /></i><span
                                                                className="kt-menu__link-text">Buttons</span></a></li>
                                                    <li className="kt-menu__item " aria-haspopup="true"><a
                                                            href="demo1/components/base/button-group.html"
                                                            className="kt-menu__link "><i
                                                                className="kt-menu__link-bullet kt-menu__link-bullet--dot"><span /></i><span
                                                                className="kt-menu__link-text">Button Group</span></a>
                                                    </li>
                                                    <li className="kt-menu__item " aria-haspopup="true"><a
                                                            href="demo1/components/base/dropdown.html"
                                                            className="kt-menu__link "><i
                                                                className="kt-menu__link-bullet kt-menu__link-bullet--dot"><span /></i><span
                                                    ...
                                                    <li className="kt-menu__item  kt-menu__item--submenu"
                                                        aria-haspopup="true" data-ktmenu-submenu-toggle="hover"><a
                                                            ...
                                                            className="kt-menu__link kt-menu__toggle"><i
                                                                className="kt-menu__link-bullet kt-menu__link-bullet--dot"><span /></i><span
                                                                className="kt-menu__link-text">Tabs</span><i
                                                                className="kt-menu__ver-arrow la la-angle-right" /></a>
                                                        <div className="kt-menu__submenu "><span
                                                                className="kt-menu__arrow" />
                                                            <ul className="kt-menu__subnav">
                                                                <li className="kt-menu__item " aria-haspopup="true"><a
                                                                        ...
                                                                        className="kt-menu__link "><i
                                                                            className="kt-menu__link-bullet kt-menu__link-bullet--dot"><span /></i><span
                                                                            className="kt-menu__link-text">Bootstrap
                                                                            Tabs</span></a></li>
                                                                <li className="kt-menu__item " aria-haspopup="true"><a
                                                                        href="demo1/components/base/tabs/line.html"
                                                                        className="kt-menu__link "><i
                                                                            className="kt-menu__link-bullet kt-menu__link-bullet--dot"><span /></i><span
                                                                            className="kt-menu__link-text">Line
                                                                            Tabs</span></a></li>
                                                            </ul>
                                                        </div>
                                                    </li>
                                                    <li className="kt-menu__item " aria-haspopup="true"><a
                                                            href="demo1/components/base/accordions.html"
                                                            className="kt-menu__link "><i
                                                                className="kt-menu__link-bullet kt-menu__link-bullet--dot"><span /></i><span
                                                                className="kt-menu__link-text">Accordions</span></a>
                                                    </li>
                                                    <li className="kt-menu__item " aria-haspopup="true"><a
                                                            href="demo1/components/base/tables.html"
                                                            className="kt-menu__link "><i
                                                                className="kt-menu__link-bullet kt-menu__link-bullet--dot"><span /></i><span
                                                                className="kt-menu__link-text">Tables</span></a></li>
                                                    <li className="kt-menu__item " aria-haspopup="true"><a
                                                            href="demo1/components/base/progress.html"
                                                            className="kt-menu__link "><i
                                                                className="kt-menu__link-bullet kt-menu__link-bullet--dot"><span /></i><span
                                                                className="kt-menu__link-text">Progress</span></a></li>
                                                    <li className="kt-menu__item " aria-haspopup="true"><a
                                                            href="demo1/components/base/modal.html"
                                                            className="kt-menu__link "><i
                                                                className="kt-menu__link-bullet kt-menu__link-bullet--dot"><span /></i><span
                                                                className="kt-menu__link-text">Modal</span></a></li>
                                                    <li className="kt-menu__item " aria-haspopup="true"><a
                                                            href="demo1/components/base/alerts.html"
                                                            className="kt-menu__link "><i
                                                                className="kt-menu__link-bullet kt-menu__link-bullet--dot"><span /></i><span
                                                                className="kt-menu__link-text">Alerts</span></a></li>
                                                    <li className="kt-menu__item " aria-haspopup="true"><a
                                                            href="demo1/components/base/popover.html"
                                                            className="kt-menu__link "><i
                                                                className="kt-menu__link-bullet kt-menu__link-bullet--dot"><span /></i><span
                                                                className="kt-menu__link-text">Popover</span></a></li>
                                                    <li className="kt-menu__item " aria-haspopup="true"><a
                                                            href="demo1/components/base/tooltip.html"
                                                            className="kt-menu__link "><i
                                                                className="kt-menu__link-bullet kt-menu__link-bullet--dot"><span /></i><span
                                                ...
                                                className="kt-menu__link kt-menu__toggle"><span
                                                    className="kt-menu__link-icon"><svg
                                                        ...
                                                        <g stroke="none" strokeWidth={1} fill="none" fillRule="evenodd">
                                                            ...
                                                            <polygon id="Path-Copy" fill="#000000"
                                                    ...
                                                    </svg></span><span className="kt-menu__link-text">Custom</span><i
                                                    className="kt-menu__ver-arrow la la-angle-right" /></a>
                                            <div className="kt-menu__submenu "><span className="kt-menu__arrow" />
                                                <ul className="kt-menu__subnav">
                                                    <li className="kt-menu__item  kt-menu__item--parent"
                                                    ...
                                                    <li className="kt-menu__item " aria-haspopup="true"><a
                                                            href="demo1/components/custom/badge.html"
                                                            className="kt-menu__link "><i
                                                                className="kt-menu__link-bullet kt-menu__link-bullet--dot"><span /></i><span
                                                                className="kt-menu__link-text">Badge</span></a></li>
                                                    <li className="kt-menu__item " aria-haspopup="true"><a
                                                            href="demo1/components/custom/navs.html"
                                                            className="kt-menu__link "><i
                                                                className="kt-menu__link-bullet kt-menu__link-bullet--dot"><span /></i><span
                                                                className="kt-menu__link-text">Navigations</span></a>
                                                    </li>
                                                    <li className="kt-menu__item " aria-haspopup="true"><a
                                                            href="demo1/components/custom/lists.html"
                                                            className="kt-menu__link "><i
                                                                className="kt-menu__link-bullet kt-menu__link-bullet--dot"><span /></i><span
                                                                className="kt-menu__link-text">Lists</span></a></li>
                                                    <li className="kt-menu__item " aria-haspopup="true"><a
                                                            href="demo1/components/custom/notes.html"
                                                            className="kt-menu__link "><i
                                                                className="kt-menu__link-bullet kt-menu__link-bullet--dot"><span /></i><span
                                                                className="kt-menu__link-text">Notes</span></a></li>
                                                    <li className="kt-menu__item " aria-haspopup="true"><a
                                                            href="demo1/components/custom/timeline.html"
                                                            className="kt-menu__link "><i
                                                                className="kt-menu__link-bullet kt-menu__link-bullet--dot"><span /></i><span
                                                                className="kt-menu__link-text">Timeline</span></a></li>
                                                    <li className="kt-menu__item " aria-haspopup="true"><a
                                                            href="demo1/components/custom/pagination.html"
                                                            className="kt-menu__link "><i
                                                                className="kt-menu__link-bullet kt-menu__link-bullet--dot"><span /></i><span
                                                                className="kt-menu__link-text">Pagination</span></a>
                                                    </li>
                                                    <li className="kt-menu__item " aria-haspopup="true"><a
                                                            href="demo1/components/custom/spinners.html"
                                                            className="kt-menu__link "><i
                                                                className="kt-menu__link-bullet kt-menu__link-bullet--dot"><span /></i><span
                                                    ...
                                                    <li className="kt-menu__item " aria-haspopup="true"><a
                                                            ...
                                                            className="kt-menu__link "><i
                                                                className="kt-menu__link-bullet kt-menu__link-bullet--dot"><span /></i><span
                                                                className="kt-menu__link-text">Miscellaneous</span></a>
                                                    </li>
                                                </ul>
                                            </div>
                                        </li>
                                        <li className="kt-menu__item  kt-menu__item--submenu" aria-haspopup="true"
                                            data-ktmenu-submenu-toggle="hover"><a href="javascript:;"
                                                className="kt-menu__link kt-menu__toggle"><span
                                                    ...
                                                    </svg></span><span className="kt-menu__link-text">Extended</span><i
                                                    className="kt-menu__ver-arrow la la-angle-right" /></a>
                                            <div className="kt-menu__submenu "><span className="kt-menu__arrow" />
                                                <ul className="kt-menu__subnav">
                                                    <li className="kt-menu__item  kt-menu__item--parent"
                                                        aria-haspopup="true"><span className="kt-menu__link"><span
                                                                className="kt-menu__link-text">Extended</span></span>
                                                    </li>
                                                    <li className="kt-menu__item " aria-haspopup="true"><a
                                                            href="demo1/components/extended/blockui.html"
                                                            className="kt-menu__link "><i
                                                                className="kt-menu__link-bullet kt-menu__link-bullet--dot"><span /></i><span
                                                    ...
                                                    <li className="kt-menu__item " aria-haspopup="true"><a
                                                            ...
                                                            className="kt-menu__link "><i
                                                                className="kt-menu__link-bullet kt-menu__link-bullet--dot"><span /></i><span
                                                                className="kt-menu__link-text">Perfect
                                                                Scrollbar</span></a></li>
                                                    <li className="kt-menu__item " aria-haspopup="true"><a
                                                            href="demo1/components/extended/treeview.html"
                                                            className="kt-menu__link "><i
                                                                className="kt-menu__link-bullet kt-menu__link-bullet--dot"><span /></i><span
                                                    ...
                                                    <li className="kt-menu__item " aria-haspopup="true"><a
                                                            ...
                                                            className="kt-menu__link "><i
                                                                ...
                                                                Notify</span></a></li>
                                                    <li className="kt-menu__item " aria-haspopup="true"><a
                                                            href="demo1/components/extended/toastr.html"
                                                            className="kt-menu__link "><i
                                                                className="kt-menu__link-bullet kt-menu__link-bullet--dot"><span /></i><span
                                                    ...
                                                    <li className="kt-menu__item " aria-haspopup="true"><a
                                                            ...
                                                            className="kt-menu__link "><i
                                                                className="kt-menu__link-bullet kt-menu__link-bullet--dot"><span /></i><span
                                                                className="kt-menu__link-text">SweetAlert2</span></a>
                                                    </li>
                                                </ul>
                                            </div>
                                        </li>
                                        <li className="kt-menu__item  kt-menu__item--submenu" aria-haspopup="true"
                                            data-ktmenu-submenu-toggle="hover"><a href="javascript:;"
                                                className="kt-menu__link kt-menu__toggle"><span
                                                    ...
                                                    </svg></span><span className="kt-menu__link-text">Icons</span><i
                                                    className="kt-menu__ver-arrow la la-angle-right" /></a>
                                            <div className="kt-menu__submenu "><span className="kt-menu__arrow" />
                                                <ul className="kt-menu__subnav">
                                                    <li className="kt-menu__item " aria-haspopup="true"><a
                                                            href="demo1/components/icons/flaticon.html"
                                                            className="kt-menu__link "><i
                                                                className="kt-menu__link-bullet kt-menu__link-bullet--dot"><span /></i><span
                                                    ...
                                                    <li className="kt-menu__item " aria-haspopup="true"><a
                                                            ...
                                                            className="kt-menu__link "><i
                                                                className="kt-menu__link-bullet kt-menu__link-bullet--dot"><span /></i><span
                                                                className="kt-menu__link-text">Fontawesome 5</span></a>
                                                    </li>
                                                    <li className="kt-menu__item " aria-haspopup="true"><a
                                                            href="demo1/components/icons/lineawesome.html"
                                                            className="kt-menu__link "><i
                                                                className="kt-menu__link-bullet kt-menu__link-bullet--dot"><span /></i><span
                                                                className="kt-menu__link-text">Lineawesome</span></a>
                                                    </li>
                                                    <li className="kt-menu__item " aria-haspopup="true"><a
                                                            href="demo1/components/icons/socicons.html"
                                                            className="kt-menu__link "><i
                                                                className="kt-menu__link-bullet kt-menu__link-bullet--dot"><span /></i><span
                                                                className="kt-menu__link-text">Socicons</span></a></li>
                                                    <li className="kt-menu__item " aria-haspopup="true"><a
                                                            href="demo1/components/icons/svg.html"
                                                            className="kt-menu__link "><i
                                                                className="kt-menu__link-bullet kt-menu__link-bullet--dot"><span /></i><span
                                        ...
                                        <li className="kt-menu__item  kt-menu__item--submenu" aria-haspopup="true"
                                            data-ktmenu-submenu-toggle="hover"><a href="javascript:;"
                                                className="kt-menu__link kt-menu__toggle"><span
                                                    ...
                                                    </svg></span><span className="kt-menu__link-text">Portlets</span><i
                                                    className="kt-menu__ver-arrow la la-angle-right" /></a>
                                            <div className="kt-menu__submenu "><span className="kt-menu__arrow" />
                                                <ul className="kt-menu__subnav">
                                                    <li className="kt-menu__item  kt-menu__item--parent"
                                                        aria-haspopup="true"><span className="kt-menu__link"><span
                                                                className="kt-menu__link-text">Portlets</span></span>
                                                    </li>
                                                    <li className="kt-menu__item " aria-haspopup="true"><a
                                                            href="demo1/components/portlets/base.html"
                                                            className="kt-menu__link "><i
                                                                className="kt-menu__link-bullet kt-menu__link-bullet--dot"><span /></i><span
                                                                className="kt-menu__link-text">Base Portlets</span></a>
                                                    </li>
                                                    <li className="kt-menu__item " aria-haspopup="true"><a
                                                            href="demo1/components/portlets/advanced.html"
                                                            className="kt-menu__link "><i
                                                                className="kt-menu__link-bullet kt-menu__link-bullet--dot"><span /></i><span
                                                                className="kt-menu__link-text">Advanced
                                                                Portlets</span></a></li>
                                                    <li className="kt-menu__item " aria-haspopup="true"><a
                                                            href="demo1/components/portlets/tabbed.html"
                                                            className="kt-menu__link "><i
                                                                className="kt-menu__link-bullet kt-menu__link-bullet--dot"><span /></i><span
                                                                className="kt-menu__link-text">Tabbed
                                                                Portlets</span></a></li>
                                                    <li className="kt-menu__item " aria-haspopup="true"><a
                                                            href="demo1/components/portlets/draggable.html"
                                                            className="kt-menu__link "><i
                                                                className="kt-menu__link-bullet kt-menu__link-bullet--dot"><span /></i><span
                                                                className="kt-menu__link-text">Draggable
                                                                Portlets</span></a></li>
                                                    <li className="kt-menu__item " aria-haspopup="true"><a
                                                            href="demo1/components/portlets/tools.html"
                                                            className="kt-menu__link "><i
                                                                className="kt-menu__link-bullet kt-menu__link-bullet--dot"><span /></i><span
                                                                className="kt-menu__link-text">Portlet Tools</span></a>
                                                    </li>
                                                    <li className="kt-menu__item " aria-haspopup="true"><a
                                                            href="demo1/components/portlets/sticky-head.html"
                                                            className="kt-menu__link "><i
                                                                className="kt-menu__link-bullet kt-menu__link-bullet--dot"><span /></i><span
                                                                className="kt-menu__link-text">Sticky Head</span></a>
                                                    </li>
                                                </ul>
                                            </div>
                                        </li>
                                                    ...
                                                    className="kt-menu__link-icon"><svg
                                                        ...
                                                        <g stroke="none" strokeWidth={1} fill="none" fillRule="evenodd">
                                                            ...
                                                            <path
                                                                ...
                                                                id="Path-108" fill="#000000" fillRule="nonzero" />
                                                            <circle id="Oval" fill="#000000" opacity="0.3" cx={19}
                                                                cy={6} r={1} />
                                                        </g>
                                                    </svg></span><span className="kt-menu__link-text">Widgets</span><i
                                                    className="kt-menu__ver-arrow la la-angle-right" /></a>
                                            <div className="kt-menu__submenu "><span className="kt-menu__arrow" />
                                                <ul className="kt-menu__subnav">
                                                    <li className="kt-menu__item  kt-menu__item--parent"
                                                        aria-haspopup="true"><span className="kt-menu__link"><span
                                                                className="kt-menu__link-text">Widgets</span></span>
                                                    </li>
                                                    <li className="kt-menu__item " aria-haspopup="true"><a
                                                            href="demo1/components/widgets/lists.html"
                                                            className="kt-menu__link "><i
                                                                className="kt-menu__link-bullet kt-menu__link-bullet--dot"><span /></i><span
                                                                className="kt-menu__link-text">Lists</span></a></li>
                                                    <li className="kt-menu__item " aria-haspopup="true"><a
                                                            href="demo1/components/widgets/charts.html"
                                                            className="kt-menu__link "><i
                                                                className="kt-menu__link-bullet kt-menu__link-bullet--dot"><span /></i><span
                                                                className="kt-menu__link-text">Charts</span></a></li>
                                                    <li className="kt-menu__item " aria-haspopup="true"><a
                                                            href="demo1/components/widgets/general.html"
                                                            className="kt-menu__link "><i
                                                                className="kt-menu__link-bullet kt-menu__link-bullet--dot"><span /></i><span
                                        ...
                                        <li className="kt-menu__item  kt-menu__item--submenu" aria-haspopup="true"
                                            data-ktmenu-submenu-toggle="hover"><a href="javascript:;"
                                                className="kt-menu__link kt-menu__toggle"><span
                                                    ...
                                                    </svg></span><span className="kt-menu__link-text">Calendar</span><i
                                                    className="kt-menu__ver-arrow la la-angle-right" /></a>
                                            <div className="kt-menu__submenu "><span className="kt-menu__arrow" />
                                                <ul className="kt-menu__subnav">
                                                    <li className="kt-menu__item  kt-menu__item--parent"
                                                        aria-haspopup="true"><span className="kt-menu__link"><span
                                                                className="kt-menu__link-text">Calendar</span></span>
                                                    </li>
                                                    <li className="kt-menu__item " aria-haspopup="true"><a
                                                            href="demo1/components/calendar/basic.html"
                                                            className="kt-menu__link "><i
                                                                className="kt-menu__link-bullet kt-menu__link-bullet--dot"><span /></i><span
                                                                className="kt-menu__link-text">Basic Calendar</span></a>
                                                    </li>
                                                    <li className="kt-menu__item " aria-haspopup="true"><a
                                                            href="demo1/components/calendar/list-view.html"
                                                            className="kt-menu__link "><i
                                                                className="kt-menu__link-bullet kt-menu__link-bullet--dot"><span /></i><span
                                                                className="kt-menu__link-text">List Views</span></a>
                                                    </li>
                                                    <li className="kt-menu__item " aria-haspopup="true"><a
                                                            href="demo1/components/calendar/google.html"
                                                            className="kt-menu__link "><i
                                                                className="kt-menu__link-bullet kt-menu__link-bullet--dot"><span /></i><span
                                                                className="kt-menu__link-text">Google
                                                                Calendar</span></a></li>
                                                    <li className="kt-menu__item " aria-haspopup="true"><a
                                                            href="demo1/components/calendar/external-events.html"
                                                            className="kt-menu__link "><i
                                                                className="kt-menu__link-bullet kt-menu__link-bullet--dot"><span /></i><span
                                                                className="kt-menu__link-text">External
                                                                Events</span></a></li>
                                                    <li className="kt-menu__item " aria-haspopup="true"><a
                                                            href="demo1/components/calendar/background-events.html"
                                                            className="kt-menu__link "><i
                                                                className="kt-menu__link-bullet kt-menu__link-bullet--dot"><span /></i><span
                                                                className="kt-menu__link-text">Background
                                                                Events</span></a></li>
                                                </ul>
                                            </div>
                                        </li>
                                            ...
                                            data-ktmenu-submenu-toggle="hover"><a href="javascript:;"
                                                className="kt-menu__link kt-menu__toggle"><span
                                                    className="kt-menu__link-icon"><svg
                                                        ...
                                                        <g stroke="none" strokeWidth={1} fill="none" fillRule="evenodd">
                                                            <rect id="bound" x={0} y={0} width={24} height={24} />
                                                            <rect id="Rectangle-62-Copy" fill="#000000" opacity="0.3"
                                                                x={13} y={4} width={3} height={16} rx="1.5" />
                                                    ...
                                                    </svg></span><span className="kt-menu__link-text">Charts</span><i
                                                    className="kt-menu__ver-arrow la la-angle-right" /></a>
                                            <div className="kt-menu__submenu "><span className="kt-menu__arrow" />
                                                <ul className="kt-menu__subnav">
                                                    <li className="kt-menu__item  kt-menu__item--parent"
                                                        ...
                                                        <div className="kt-menu__submenu "><span
                                                            ...
                                                            <ul className="kt-menu__subnav">
                                                                <li className="kt-menu__item " aria-haspopup="true"><a
                                                                        ...
                                                                        className="kt-menu__link "><i
                                                                            className="kt-menu__link-bullet kt-menu__link-bullet--dot"><span /></i><span
                                                                            className="kt-menu__link-text">amCharts
                                                                            Charts</span></a></li>
                                                                <li className="kt-menu__item " aria-haspopup="true"><a
                                                    ...
                                                    <li className="kt-menu__item " aria-haspopup="true"><a
                                                            href="demo1/components/charts/flotcharts.html"
                                                            className="kt-menu__link "><i
                                                                className="kt-menu__link-bullet kt-menu__link-bullet--dot"><span /></i><span
                                                                className="kt-menu__link-text">Flot Charts</span></a>
                                                    </li>
                                                    <li className="kt-menu__item " aria-haspopup="true"><a
                                                            href="demo1/components/charts/google-charts.html"
                                                            className="kt-menu__link "><i
                                                                className="kt-menu__link-bullet kt-menu__link-bullet--dot"><span /></i><span
                                                                className="kt-menu__link-text">Google Charts</span></a>
                                                    </li>
                                                    <li className="kt-menu__item " aria-haspopup="true"><a
                                                            href="demo1/components/charts/morris-charts.html"
                                                            className="kt-menu__link "><i
                                                                className="kt-menu__link-bullet kt-menu__link-bullet--dot"><span /></i><span
                                                                className="kt-menu__link-text">Morris Charts</span></a>
                                                    </li>
                                                </ul>
                                            </div>
                                        </li>
                                        <li className="kt-menu__item  kt-menu__item--submenu" aria-haspopup="true"
                                            data-ktmenu-submenu-toggle="hover"><a href="javascript:;"
                                                className="kt-menu__link kt-menu__toggle"><span
                                                    ...
                                                    </svg></span><span className="kt-menu__link-text">Maps</span><i
                                                    className="kt-menu__ver-arrow la la-angle-right" /></a>
                                            <div className="kt-menu__submenu "><span className="kt-menu__arrow" />
                                                <ul className="kt-menu__subnav">
                                                    <li className="kt-menu__item  kt-menu__item--parent"
                                                    ...
                                                    <li className="kt-menu__item " aria-haspopup="true"><a
                                                            href="demo1/components/maps/google-maps.html"
                                                            className="kt-menu__link "><i
                                                                className="kt-menu__link-bullet kt-menu__link-bullet--dot"><span /></i><span
                                                                className="kt-menu__link-text">Google Maps</span></a>
                                                    </li>
                                                    <li className="kt-menu__item " aria-haspopup="true"><a
                                                            href="demo1/components/maps/jqvmap.html"
                                                            className="kt-menu__link "><i
                                                                className="kt-menu__link-bullet kt-menu__link-bullet--dot"><span /></i><span
                                        ...
                                        <li className="kt-menu__item  kt-menu__item--submenu" aria-haspopup="true"
                                            data-ktmenu-submenu-toggle="hover"><a href="javascript:;"
                                                className="kt-menu__link kt-menu__toggle"><span
                                                    ...
                                                    </svg></span><span className="kt-menu__link-text">Utils</span><i
                                                    className="kt-menu__ver-arrow la la-angle-right" /></a>
                                            <div className="kt-menu__submenu "><span className="kt-menu__arrow" />
                                                <ul className="kt-menu__subnav">
                                                    <li className="kt-menu__item  kt-menu__item--parent"
                                                    ...
                                                    <li className="kt-menu__item " aria-haspopup="true"><a
                                                            ...
                                                            className="kt-menu__link "><i
                                                                className="kt-menu__link-bullet kt-menu__link-bullet--dot"><span /></i><span
                                                                className="kt-menu__link-text">Session
                                                                Timeout</span></a></li>
                                                    <li className="kt-menu__item " aria-haspopup="true"><a
                                                            href="demo1/components/utils/idle-timer.html"
                                                            className="kt-menu__link "><i
                                                                className="kt-menu__link-bullet kt-menu__link-bullet--dot"><span /></i><span
                                                                className="kt-menu__link-text">Idle Timer</span></a>
                                                    </li>
                                                </ul>
                                            </div>
                                        </li>
                                        ...
                                        <li className="kt-menu__item  kt-menu__item--submenu" aria-haspopup="true"
                                            data-ktmenu-submenu-toggle="hover"><a href="javascript:;"
                                                className="kt-menu__link kt-menu__toggle"><span
                                                    ...
                                                    </svg></span><span className="kt-menu__link-text">Forms</span><i
                                                    className="kt-menu__ver-arrow la la-angle-right" /></a>
                                            <div className="kt-menu__submenu "><span className="kt-menu__arrow" />
                                                <ul className="kt-menu__subnav">
                                                    <li className="kt-menu__item  kt-menu__item--parent"
                                                        ...
                                                        <div className="kt-menu__submenu "><span
                                                            ...
                                                            <ul className="kt-menu__subnav">
                                                                <li className="kt-menu__item " aria-haspopup="true"><a
                                                                        ...
                                                                        className="kt-menu__link "><i
                                                                            className="kt-menu__link-bullet kt-menu__link-bullet--dot"><span /></i><span
                                                                            className="kt-menu__link-text">Base
                                                                            Inputs</span></a></li>
                                                                <li className="kt-menu__item " aria-haspopup="true"><a
                                                                        href="demo1/crud/forms/controls/input-group.html"
                                                                        className="kt-menu__link "><i
                                                                            className="kt-menu__link-bullet kt-menu__link-bullet--dot"><span /></i><span
                                                                            className="kt-menu__link-text">Input
                                                                            Groups</span></a></li>
                                                                <li className="kt-menu__item " aria-haspopup="true"><a
                                                                        href="demo1/crud/forms/controls/checkbox.html"
                                                                        className="kt-menu__link "><i
                                                                            className="kt-menu__link-bullet kt-menu__link-bullet--dot"><span /></i><span
                                                                            className="kt-menu__link-text">Checkbox</span></a>
                                                                </li>
                                                                <li className="kt-menu__item " aria-haspopup="true"><a
                                                                        href="demo1/crud/forms/controls/radio.html"
                                                                        className="kt-menu__link "><i
                                                                            className="kt-menu__link-bullet kt-menu__link-bullet--dot"><span /></i><span
                                                                            className="kt-menu__link-text">Radio</span></a>
                                                                </li>
                                                                <li className="kt-menu__item " aria-haspopup="true"><a
                                                                        href="demo1/crud/forms/controls/switch.html"
                                                                        className="kt-menu__link "><i
                                                                            className="kt-menu__link-bullet kt-menu__link-bullet--dot"><span /></i><span
                                                                            className="kt-menu__link-text">Switch</span></a>
                                                                </li>
                                                                <li className="kt-menu__item " aria-haspopup="true"><a
                                                                        href="demo1/crud/forms/controls/option.html"
                                                                        className="kt-menu__link "><i
                                                                            className="kt-menu__link-bullet kt-menu__link-bullet--dot"><span /></i><span
                                                                            className="kt-menu__link-text">Mega
                                                                            Options</span></a></li>
                                                            </ul>
                                                        </div>
                                                    </li>
                                                        ...
                                                        <div className="kt-menu__submenu "><span
                                                            ...
                                                            <ul className="kt-menu__subnav">
                                                                <li className="kt-menu__item " aria-haspopup="true"><a
                                                                        ...
                                                                        className="kt-menu__link "><i
                                                                            className="kt-menu__link-bullet kt-menu__link-bullet--dot"><span /></i><span
                                                                            className="kt-menu__link-text">Datepicker</span></a>
                                                                </li>
                                                                <li className="kt-menu__item " aria-haspopup="true"><a
                                                                ...
                                                                <li className="kt-menu__item " aria-haspopup="true"><a
                                                                        ...
                                                                        className="kt-menu__link "><i
                                                                            className="kt-menu__link-bullet kt-menu__link-bullet--dot"><span /></i><span
                                                                            className="kt-menu__link-text">Timepicker</span></a>
                                                                </li>
                                                                <li className="kt-menu__item " aria-haspopup="true"><a
                                                                ...
                                                                <li className="kt-menu__item " aria-haspopup="true"><a
                                                                        ...
                                                                        className="kt-menu__link "><i
                                                                            className="kt-menu__link-bullet kt-menu__link-bullet--dot"><span /></i><span
                                                                            className="kt-menu__link-text">Touchspin</span></a>
                                                                </li>
                                                                <li className="kt-menu__item " aria-haspopup="true"><a
                                                                        href="demo1/crud/forms/widgets/bootstrap-maxlength.html"
                                                                        className="kt-menu__link "><i
                                                                            className="kt-menu__link-bullet kt-menu__link-bullet--dot"><span /></i><span
                                                                            className="kt-menu__link-text">Maxlength</span></a>
                                                                </li>
                                                                <li className="kt-menu__item " aria-haspopup="true"><a
                                                                ...
                                                                <li className="kt-menu__item " aria-haspopup="true"><a
                                                                        ...
                                                                        className="kt-menu__link "><i
                                                                            className="kt-menu__link-bullet kt-menu__link-bullet--dot"><span /></i><span
                                                                            className="kt-menu__link-text">Multiple
                                                                ...
                                                                <li className="kt-menu__item " aria-haspopup="true"><a
                                                                        ...
                                                                        className="kt-menu__link "><i
                                                                            className="kt-menu__link-bullet kt-menu__link-bullet--dot"><span /></i><span
                                                                            className="kt-menu__link-text">Select2</span></a>
                                                                </li>
                                                                <li className="kt-menu__item " aria-haspopup="true"><a
                                                                        href="demo1/crud/forms/widgets/typeahead.html"
                                                                        className="kt-menu__link "><i
                                                                            className="kt-menu__link-bullet kt-menu__link-bullet--dot"><span /></i><span
                                                                            className="kt-menu__link-text">Typeahead</span></a>
                                                                </li>
                                                                <li className="kt-menu__item " aria-haspopup="true"><a
                                                                        href="demo1/crud/forms/widgets/nouislider.html"
                                                                        className="kt-menu__link "><i
                                                                            className="kt-menu__link-bullet kt-menu__link-bullet--dot"><span /></i><span
                                                                            className="kt-menu__link-text">noUiSlider</span></a>
                                                                </li>
                                                                <li className="kt-menu__item " aria-haspopup="true"><a
                                                                        href="demo1/crud/forms/widgets/form-repeater.html"
                                                                        className="kt-menu__link "><i
                                                                            className="kt-menu__link-bullet kt-menu__link-bullet--dot"><span /></i><span
                                                                            className="kt-menu__link-text">Form
                                                                            Repeater</span></a></li>
                                                                <li className="kt-menu__item " aria-haspopup="true"><a
                                                                        href="demo1/crud/forms/widgets/ion-range-slider.html"
                                                                        className="kt-menu__link "><i
                                                                            className="kt-menu__link-bullet kt-menu__link-bullet--dot"><span /></i><span
                                                                            className="kt-menu__link-text">Ion Range
                                                                            Slider</span></a></li>
                                                                <li className="kt-menu__item " aria-haspopup="true"><a
                                                                ...
                                                                <li className="kt-menu__item " aria-haspopup="true"><a
                                                                        ...
                                                                        className="kt-menu__link "><i
                                                                            className="kt-menu__link-bullet kt-menu__link-bullet--dot"><span /></i><span
                                                                            className="kt-menu__link-text">Summernote
                                                                            WYSIWYG</span></a></li>
                                                                <li className="kt-menu__item " aria-haspopup="true"><a
                                                                        href="demo1/crud/forms/widgets/bootstrap-markdown.html"
                                                                        className="kt-menu__link "><i
                                                                            className="kt-menu__link-bullet kt-menu__link-bullet--dot"><span /></i><span
                                                                            className="kt-menu__link-text">Markdown
                                                                            Editor</span></a></li>
                                                                <li className="kt-menu__item " aria-haspopup="true"><a
                                                                        href="demo1/crud/forms/widgets/autosize.html"
                                                                        className="kt-menu__link "><i
                                                                            className="kt-menu__link-bullet kt-menu__link-bullet--dot"><span /></i><span
                                                                            className="kt-menu__link-text">Autosize</span></a>
                                                                </li>
                                                                <li className="kt-menu__item " aria-haspopup="true"><a
                                                                        href="demo1/crud/forms/widgets/clipboard.html"
                                                                        className="kt-menu__link "><i
                                                                            className="kt-menu__link-bullet kt-menu__link-bullet--dot"><span /></i><span
                                                                            className="kt-menu__link-text">Clipboard</span></a>
                                                                </li>
                                                                <li className="kt-menu__item " aria-haspopup="true"><a
                                                                        href="demo1/crud/forms/widgets/dropzone.html"
                                                                        className="kt-menu__link "><i
                                                                            className="kt-menu__link-bullet kt-menu__link-bullet--dot"><span /></i><span
                                                                            className="kt-menu__link-text">Dropzone</span></a>
                                                                </li>
                                                                <li className="kt-menu__item " aria-haspopup="true"><a
                                                        ...
                                                        <div className="kt-menu__submenu "><span
                                                            ...
                                                            <ul className="kt-menu__subnav">
                                                                <li className="kt-menu__item " aria-haspopup="true"><a
                                                                        ...
                                                                        className="kt-menu__link "><i
                                                                            className="kt-menu__link-bullet kt-menu__link-bullet--dot"><span /></i><span
                                                                            className="kt-menu__link-text">Default
                                                                            Forms</span></a></li>
                                                                <li className="kt-menu__item " aria-haspopup="true"><a
                                                                        href="demo1/crud/forms/layouts/multi-column-forms.html"
                                                                        className="kt-menu__link "><i
                                                                            className="kt-menu__link-bullet kt-menu__link-bullet--dot"><span /></i><span
                                                                            className="kt-menu__link-text">Multi Column
                                                                            Forms</span></a></li>
                                                                <li className="kt-menu__item " aria-haspopup="true"><a
                                                                        href="demo1/crud/forms/layouts/action-bars.html"
                                                                        className="kt-menu__link "><i
                                                                            className="kt-menu__link-bullet kt-menu__link-bullet--dot"><span /></i><span
                                                                            className="kt-menu__link-text">Basic Action
                                                                            Bars</span></a></li>
                                                                <li className="kt-menu__item " aria-haspopup="true"><a
                                                                        href="demo1/crud/forms/layouts/sticky-action-bar.html"
                                                                        className="kt-menu__link "><i
                                                                            className="kt-menu__link-bullet kt-menu__link-bullet--dot"><span /></i><span
                                                                            className="kt-menu__link-text">Sticky Action
                                                                            Bar</span></a></li>
                                                            </ul>
                                                        </div>
                                                    </li>
                                                        ...
                                                        <div className="kt-menu__submenu "><span
                                                            ...
                                                            <ul className="kt-menu__subnav">
                                                                <li className="kt-menu__item " aria-haspopup="true"><a
                                                                        ...
                                                                        className="kt-menu__link "><i
                                                                            className="kt-menu__link-bullet kt-menu__link-bullet--dot"><span /></i><span
                                                                            className="kt-menu__link-text">Validation
                                                                            States</span></a></li>
                                                                <li className="kt-menu__item " aria-haspopup="true"><a
                                        ...
                                        <li className="kt-menu__item  kt-menu__item--submenu" aria-haspopup="true"
                                                    ...
                                                    className="kt-menu__link-icon"><svg
                                                        ...
                                                        <g stroke="none" strokeWidth={1} fill="none" fillRule="evenodd">
                                                            ...
                                                            <path
                                                                ...
                                                                id="Combined-Shape" fill="#000000" />
                                                            <rect id="Rectangle-7-Copy-2" fill="#000000" opacity="0.3"
                                                                x={2} y={4} width={5} height={16} rx={1} />
                                                        </g>
                                                    </svg></span><span
                                            ...
                                            <div className="kt-menu__submenu "><span className="kt-menu__arrow" />
                                                <ul className="kt-menu__subnav">
                                                    <li className="kt-menu__item  kt-menu__item--parent"
                                                        aria-haspopup="true"><span className="kt-menu__link"><span
                                                                className="kt-menu__link-text">KTDatatable</span></span>
                                                    </li>
                                                    <li className="kt-menu__item  kt-menu__item--submenu"
                                                        aria-haspopup="true" data-ktmenu-submenu-toggle="hover"><a
                                                            href="javascript:;"
                                                        ...
                                                        <div className="kt-menu__submenu "><span
                                                            ...
                                                            <ul className="kt-menu__subnav">
                                                                ...
                                                                <li className="kt-menu__item " aria-haspopup="true"><a
                                                                        ...
                                                                        className="kt-menu__link "><i
                                                                            className="kt-menu__link-bullet kt-menu__link-bullet--dot"><span /></i><span
                                                                            className="kt-menu__link-text">Translation</span></a>
                                                                </li>
                                                            </ul>
                                                        </div>
                                                    </li>
                                                        ...
                                                        <div className="kt-menu__submenu "><span
                                                            ...
                                                            <ul className="kt-menu__subnav">
                                                                ...
                                                                <li className="kt-menu__item " aria-haspopup="true"><a
                                                                        ...
                                                                        className="kt-menu__link "><i
                                                                            className="kt-menu__link-bullet kt-menu__link-bullet--dot"><span /></i><span
                                                                            className="kt-menu__link-text">Vertical
                                                                            Scrolling</span></a></li>
                                                            </ul>
                                                        </div>
                                                    </li>
                                                        ...
                                                        <div className="kt-menu__submenu "><span
                                                            ...
                                                            <ul className="kt-menu__subnav">
                                                                ...
                                                                <li className="kt-menu__item " aria-haspopup="true"><a
                                                                        ...
                                                                        className="kt-menu__link "><i
                                                                            className="kt-menu__link-bullet kt-menu__link-bullet--dot"><span /></i><span
                                                                            className="kt-menu__link-text">Remote
                                                                            Data</span></a></li>
                                                            </ul>
                                                        </div>
                                                    </li>
                                                        ...
                                                        <div className="kt-menu__submenu "><span
                                                            ...
                                                            <ul className="kt-menu__subnav">
                                                                <li className="kt-menu__item " aria-haspopup="true"><a
                                                                        ...
                                                                        className="kt-menu__link "><i
                                                                            className="kt-menu__link-bullet kt-menu__link-bullet--dot"><span /></i><span
                                                                            className="kt-menu__link-text">API
                                                                            Methods</span></a></li>
                                                                <li className="kt-menu__item " aria-haspopup="true"><a
                                                                        href="demo1/crud/metronic-datatable/api/events.html"
                                                                        className="kt-menu__link "><i
                                                                            className="kt-menu__link-bullet kt-menu__link-bullet--dot"><span /></i><span
                                                                            className="kt-menu__link-text">Events</span></a>
                                                                </li>
                                                            </ul>
                                                        </div>
                                                    </li>
                                        ...
                                        <li className="kt-menu__item  kt-menu__item--submenu" aria-haspopup="true"
                                            data-ktmenu-submenu-toggle="hover"><a href="javascript:;"
                                                className="kt-menu__link kt-menu__toggle"><span
                                                    className="kt-menu__link-icon"><svg
                                                        ...
                                                        <g stroke="none" strokeWidth={1} fill="none" fillRule="evenodd">
                                                            <rect id="bound" x={0} y={0} width={24} height={24} />
                                                            <rect id="Rectangle-7" fill="#000000" opacity="0.3" x={4}
                                                                y={5} width={16} height={6} rx="1.5" />
                                            ...
                                            <div className="kt-menu__submenu "><span className="kt-menu__arrow" />
                                                <ul className="kt-menu__subnav">
                                                    <li className="kt-menu__item  kt-menu__item--parent"
                                                        aria-haspopup="true"><span className="kt-menu__link"><span
                                                                className="kt-menu__link-text">Datatables.net</span></span>
                                                    </li>
                                                    <li className="kt-menu__item  kt-menu__item--submenu"
                                                        aria-haspopup="true" data-ktmenu-submenu-toggle="hover"><a
                                                            href="javascript:;"
                                                        ...
                                                        <div className="kt-menu__submenu "><span
                                                            ...
                                                            <ul className="kt-menu__subnav">
                                                                <li className="kt-menu__item " aria-haspopup="true"><a
                                                                        ...
                                                                        className="kt-menu__link "><i
                                                                            className="kt-menu__link-bullet kt-menu__link-bullet--dot"><span /></i><span
                                                                            className="kt-menu__link-text">Basic
                                                                            Tables</span></a></li>
                                                                <li className="kt-menu__item " aria-haspopup="true"><a
                                                                        href="demo1/crud/datatables/basic/scrollable.html"
                                                                        className="kt-menu__link "><i
                                                                            className="kt-menu__link-bullet kt-menu__link-bullet--dot"><span /></i><span
                                                                            className="kt-menu__link-text">Scrollable
                                                                            Tables</span></a></li>
                                                                <li className="kt-menu__item " aria-haspopup="true"><a
                                                                        href="demo1/crud/datatables/basic/headers.html"
                                                                        className="kt-menu__link "><i
                                                                            className="kt-menu__link-bullet kt-menu__link-bullet--dot"><span /></i><span
                                                                            className="kt-menu__link-text">Complex
                                                                            Headers</span></a></li>
                                                                <li className="kt-menu__item " aria-haspopup="true"><a
                                                                        href="demo1/crud/datatables/basic/paginations.html"
                                                                        className="kt-menu__link "><i
                                                                            className="kt-menu__link-bullet kt-menu__link-bullet--dot"><span /></i><span
                                                                            className="kt-menu__link-text">Pagination
                                                                            Options</span></a></li>
                                                            </ul>
                                                        </div>
                                                    </li>
                                                        ...
                                                        <div className="kt-menu__submenu "><span
                                                            ...
                                                            <ul className="kt-menu__subnav">
                                                                ...
                                                                <li className="kt-menu__item " aria-haspopup="true"><a
                                                                        ...
                                                                        className="kt-menu__link "><i
                                                                            className="kt-menu__link-bullet kt-menu__link-bullet--dot"><span /></i><span
                                                                            className="kt-menu__link-text">Footer
                                                                            Callback</span></a></li>
                                                            </ul>
                                                        </div>
                                                    </li>
                                                        ...
                                                        <div className="kt-menu__submenu "><span
                                                            ...
                                                            <ul className="kt-menu__subnav">
                                                                <li className="kt-menu__item " aria-haspopup="true"><a
                                                                        ...
                                                                        className="kt-menu__link "><i
                                                                            className="kt-menu__link-bullet kt-menu__link-bullet--dot"><span /></i><span
                                                                            className="kt-menu__link-text">HTML</span></a>
                                                                </li>
                                                                <li className="kt-menu__item " aria-haspopup="true"><a
                                                                        href="demo1/crud/datatables/data-sources/javascript.html"
                                                                        className="kt-menu__link "><i
                                                                            className="kt-menu__link-bullet kt-menu__link-bullet--dot"><span /></i><span
                                                                            className="kt-menu__link-text">Javascript</span></a>
                                                                </li>
                                                                <li className="kt-menu__item " aria-haspopup="true"><a
                            ...
                            <div id="kt_header" className="kt-header kt-grid__item  kt-header--fixed ">
                                ...
                                <div className="kt-header-menu-wrapper" id="kt_header_menu_wrapper">
                                    <div id="kt_header_menu"
                                        ...
                                        <ul className="kt-menu__nav ">
                                            <li className="kt-menu__item  kt-menu__item--open kt-menu__item--here kt-menu__item--submenu kt-menu__item--rel kt-menu__item--open kt-menu__item--here kt-menu__item--active"
                                                ...
                                                <div
                                                    ...
                                                    <ul className="kt-menu__subnav">
                                                        <li className="kt-menu__item  kt-menu__item--active "
                                                            aria-haspopup="true"><a href="demo1/index.html"
                                                        ...
                                                        <li className="kt-menu__item " aria-haspopup="true"><a
                                                                href="javascript:;" className="kt-menu__link "><span
                                                                    ...
                                                                    className="kt-menu__link-text">Task
                                                                    Manager</span><span
                                                                    className="kt-menu__link-badge"><span
                                                                        className="kt-badge kt-badge--success">2</span></span></a>
                                                        </li>
                                                        <li className="kt-menu__item  kt-menu__item--submenu"
                                                            data-ktmenu-submenu-toggle="hover" aria-haspopup="true"><a
                                                                ...
                                                                className="kt-menu__link kt-menu__toggle"><span
                                                                    ...
                                                                    className="kt-menu__link-text">Team Manager</span><i
                                                                    className="kt-menu__hor-arrow la la-angle-right" /><i
                                                                    className="kt-menu__ver-arrow la la-angle-right" /></a>
                                                            <div
                                                                ...
                                                                <ul className="kt-menu__subnav">
                                                                    ...
                                                                    <li className="kt-menu__item " aria-haspopup="true">
                                                                        <a href="javascript:;"
                                                                            className="kt-menu__link "><i
                                                                                className="kt-menu__link-bullet kt-menu__link-bullet--dot"><span /></i><span
                                                                                className="kt-menu__link-text">Delete
                                                                                Team Member</span></a></li>
                                                                    <li className="kt-menu__item " aria-haspopup="true">
                                                                        <a href="javascript:;"
                                                                            className="kt-menu__link "><i
                                                                                className="kt-menu__link-bullet kt-menu__link-bullet--dot"><span /></i><span
                                                                                className="kt-menu__link-text">Team
                                                                                Member Reports</span></a></li>
                                                                    <li className="kt-menu__item " aria-haspopup="true">
                                                                        <a href="javascript:;"
                                                                            className="kt-menu__link "><i
                                                                                className="kt-menu__link-bullet kt-menu__link-bullet--dot"><span /></i><span
                                                                                className="kt-menu__link-text">Assign
                                                                                Tasks</span></a></li>
                                                                    <li className="kt-menu__item " aria-haspopup="true">
                                                                        <a href="javascript:;"
                                                                            className="kt-menu__link "><i
                                                                                className="kt-menu__link-bullet kt-menu__link-bullet--dot"><span /></i><span
                                                                                className="kt-menu__link-text">Promote
                                                                                Team Member</span></a></li>
                                                                </ul>
                                                            </div>
                                                        </li>
                                                        <li className="kt-menu__item  kt-menu__item--submenu"
                                                            data-ktmenu-submenu-toggle="hover" aria-haspopup="true"><a
                                                                href="#" className="kt-menu__link kt-menu__toggle"><span
                                                                    className="kt-menu__link-icon"><svg
                                                                        xmlns="http://www.w3.org/2000/svg"
                                                                        xmlnsXlink="http://www.w3.org/1999/xlink"
                                                                        width="24px" height="24px" viewBox="0 0 24 24"
                                                                    ...
                                                                    className="kt-menu__link-text">Projects
                                                                    Manager</span><i
                                                                    className="kt-menu__hor-arrow la la-angle-right" /><i
                                                                    className="kt-menu__ver-arrow la la-angle-right" /></a>
                                                            <div
                                                        ...
                                                        <li className="kt-menu__item " aria-haspopup="true"><a
                                                                href="javascript:;" className="kt-menu__link "><span
                                                                    ...
                                                                    className="kt-menu__link-text">Create New
                                                                    Project</span></a></li>
                                                    </ul>
                                                </div>
                                            </li>
                                                    ...
                                                    <div className="kt-menu__subnav">
                                                        <ul className="kt-menu__content">
                                                                    ...
                                                                    <li className="kt-menu__item " aria-haspopup="true">
                                                                        <a href="javascript:;"
                                                                            className="kt-menu__link "><span
                                                                                ...
                                                                                className="kt-menu__link-text">Pending
                                                                                Tasks</span></a></li>
                                                                    <li className="kt-menu__item " aria-haspopup="true">
                                                                        <a href="javascript:;"
                                                                            className="kt-menu__link "><span
                                                                    ...
                                                                    <li className="kt-menu__item " aria-haspopup="true">
                                                                        <a href="javascript:;"
                                                                            className="kt-menu__link "><span
                                                                                ...
                                                                                className="kt-menu__link-text">Failed
                                                                                Tasks</span></a></li>
                                                                </ul>
                                                            </li>
                                                            <li className="kt-menu__item ">
                                                                <h3 className="kt-menu__heading kt-menu__toggle"><i
                                                                        className="kt-menu__link-bullet kt-menu__link-bullet--dot"><span /></i><span
                                                                        className="kt-menu__link-text">Profit
                                                                        Margins</span><i
                                                                        className="kt-menu__ver-arrow la la-angle-right" />
                                                                </h3>
                                                                <ul className="kt-menu__inner">
                                                                    ...
                                                                    <li className="kt-menu__item " aria-haspopup="true">
                                                                        <a href="javascript:;"
                                                                            className="kt-menu__link "><i
                                                                                className="kt-menu__link-bullet kt-menu__link-bullet--line"><span /></i><span
                                                                                className="kt-menu__link-text">Gross
                                                                                Profits</span></a></li>
                                                                    <li className="kt-menu__item " aria-haspopup="true">
                                                                        <a href="javascript:;"
                                                                            className="kt-menu__link "><i
                                                                                className="kt-menu__link-bullet kt-menu__link-bullet--line"><span /></i><span
                                                                                className="kt-menu__link-text">Nett
                                                                                Profits</span></a></li>
                                                                    <li className="kt-menu__item " aria-haspopup="true">
                                                                        <a href="javascript:;"
                                                                            className="kt-menu__link "><i
                                                                                className="kt-menu__link-bullet kt-menu__link-bullet--line"><span /></i><span
                                                                                className="kt-menu__link-text">Year to
                                                                                Date Reports</span></a></li>
                                                                    <li className="kt-menu__item " aria-haspopup="true">
                                                                        <a href="javascript:;"
                                                                            className="kt-menu__link "><i
                                                                                className="kt-menu__link-bullet kt-menu__link-bullet--line"><span /></i><span
                                                            ...
                                                            <li className="kt-menu__item ">
                                                                <h3 className="kt-menu__heading kt-menu__toggle"><i
                                                                        className="kt-menu__link-bullet kt-menu__link-bullet--dot"><span /></i><span
                                                                        className="kt-menu__link-text">Staff
                                                                        Management</span><i
                                                                        className="kt-menu__ver-arrow la la-angle-right" />
                                                                </h3>
                                                                <ul className="kt-menu__inner">
                                                                    <li className="kt-menu__item " aria-haspopup="true">
                                                                        <a href="javascript:;"
                                                                            className="kt-menu__link "><i
                                                                                className="kt-menu__link-bullet kt-menu__link-bullet--dot"><span /></i><span
                                                                                className="kt-menu__link-text">Top
                                                            ...
                                                            <li className="kt-menu__item ">
                                                                ...
                                                                <ul className="kt-menu__inner">
                                                                    ...
                                                                    <li className="kt-menu__item " aria-haspopup="true">
                                                                        <a href="javascript:;"
                                                                            className="kt-menu__link "><span
                                                                                className="kt-menu__link-text">Social
                                                                    ...
                                                                    <li className="kt-menu__item " aria-haspopup="true">
                                                                        <a href="javascript:;"
                                                                            className="kt-menu__link "><span
                                                                                className="kt-menu__link-text">Audit
                                                                                &amp; Logs</span></a></li>
                                                                </ul>
                                                            </li>
                                                        </ul>
                                                    ...
                                                    <ul className="kt-menu__subnav">
                                                        <li className="kt-menu__item " aria-haspopup="true"><a
                                                                href="javascript:;" className="kt-menu__link "><span
                                                                    ...
                                                                    className="kt-menu__link-text">Reporting</span></a>
                                                        </li>
                                                        <li className="kt-menu__item  kt-menu__item--submenu"
                                                            data-ktmenu-submenu-toggle="hover" aria-haspopup="true"><a
                                                                ...
                                                                <ul className="kt-menu__subnav">
                                                                    <li className="kt-menu__item " aria-haspopup="true">
                                                                        <a href="javascript:;"
                                                                            className="kt-menu__link "><i
                                                                                className="kt-menu__link-bullet kt-menu__link-bullet--dot"><span /></i><span
                                                                                className="kt-menu__link-text">Reached
                                                                                Users</span></a></li>
                                                                    <li className="kt-menu__item " aria-haspopup="true">
                                                                        <a href="javascript:;"
                                                                            className="kt-menu__link "><i
                                                                                className="kt-menu__link-bullet kt-menu__link-bullet--dot"><span /></i><span
                                                                                className="kt-menu__link-text">SEO
                                                                                Ranking</span></a></li>
                                                                    <li className="kt-menu__item " aria-haspopup="true">
                                                                        <a href="javascript:;"
                                                                            className="kt-menu__link "><i
                                                                                className="kt-menu__link-bullet kt-menu__link-bullet--dot"><span /></i><span
                                                                                className="kt-menu__link-text">User
                                                                                Dropout Points</span></a></li>
                                                                    <li className="kt-menu__item " aria-haspopup="true">
                                                                        <a href="javascript:;"
                                                                            className="kt-menu__link "><i
                                                                                className="kt-menu__link-bullet kt-menu__link-bullet--dot"><span /></i><span
                                                        ...
                                                        <li className="kt-menu__item " aria-haspopup="true"><a
                                                                href="javascript:;" className="kt-menu__link "><span
                                                                    ...
                                                                    className="kt-menu__link-text">Sales &amp;
                                                                    Marketing</span></a></li>
                                                        <li className="kt-menu__item " aria-haspopup="true"><a
                                                                href="javascript:;" className="kt-menu__link "><span
                                                                    className="kt-menu__link-icon"><svg
                                                                        ...
                                                                        <g stroke="none" strokeWidth={1} fill="none"
                                                                            ...
                                                                            <rect id="bound" x={0} y={0} width={24}
                                                                                height={24} />
                                                                            <polygon id="Path-75" fill="#000000"
                                                                                opacity="0.3"
                                                                    ...
                                                                    className="kt-menu__link-badge"><span
                                                                        className="kt-badge kt-badge--success">3</span></span></a>
                                                        </li>
                                                        <li className="kt-menu__item  kt-menu__item--submenu"
                                                            data-ktmenu-submenu-toggle="hover" aria-haspopup="true"><a
                                                                href="javascript:;"
                                                                className="kt-menu__link kt-menu__toggle"><span
                                                                    ...
                                                                    className="kt-menu__link-text">Deployment
                                                                    Center</span><i
                                                                    className="kt-menu__hor-arrow la la-angle-right" /><i
                                                                    className="kt-menu__ver-arrow la la-angle-right" /></a>
                                                            <div
                                                                ...
                                                                <ul className="kt-menu__subnav">
                                                                    <li className="kt-menu__item " aria-haspopup="true">
                                                                        <a href="javascript:;"
                                                                            className="kt-menu__link "><i
                                                                                className="kt-menu__link-bullet kt-menu__link-bullet--line"><span /></i><span
                                                                                className="kt-menu__link-text">Merge
                                                                                Branch</span><span
                                                                                className="kt-menu__link-badge"><span
                                                                                    className="kt-badge kt-badge--danger">3</span></span></a>
                                                                    </li>
                                                                    <li className="kt-menu__item " aria-haspopup="true">
                                                                        <a href="javascript:;"
                                                                            className="kt-menu__link "><i
                                ...
                                <div className="kt-header__topbar">
                                    ...
                                    <div className="kt-header__topbar-item kt-header__topbar-item--search dropdown"
                                        ...
                                        <div
                                            ...
                                            <div className="kt-quick-search kt-quick-search--inline"
                                                    ...
                                                    <div className="input-group">
                                                        <div className="input-group-prepend"><span
                                                                className="input-group-text"><i
                                                                    className="flaticon2-search-1" /></span></div>
                                                        <input type="text"
                                                            className="form-control kt-quick-search__input"
                                                            placeholder="Search..." />
                                                        <div className="input-group-append"><span
                                                                className="input-group-text"><i
                                                                    className="la la-close kt-quick-search__close" /></span>
                                                        </div>
                                                    </div>
                                                </form>
                                                <div className="kt-quick-search__wrapper kt-scroll" data-scroll="true"
                                            ...
                                            <form>
                                                ...
                                                <div className="kt-head kt-head--skin-dark kt-head--fit-x kt-head--fit-b"
                                                    ...
                                                    <h3 className="kt-head__title">
                                                        User Notifications
                                                        &nbsp;
                                                        <span className="btn btn-success btn-sm btn-bold btn-font-md">23
                                                            new</span>
                                                    </h3>
                                                ...
                                                <div className="tab-content">
                                                        ...
                                                        <div className="kt-notification kt-margin-t-10 kt-margin-b-10 kt-scroll"
                                                            ...
                                                            <a href="#" className="kt-notification__item">
                                                                <div className="kt-notification__item-icon">
                                                                    <i
                                                                        className="flaticon2-line-chart kt-font-success" />
                                                                </div>
                                                            ...
                                                            <a href="#" className="kt-notification__item">
                                                                <div className="kt-notification__item-icon">
                                                                    <i
                                                                        className="flaticon2-image-file kt-font-warning" />
                                                                </div>
                                                                <div className="kt-notification__item-details">
                                                                    <div className="kt-notification__item-title">
                                                            ...
                                                            <a href="#" className="kt-notification__item">
                                                                <div className="kt-notification__item-icon">
                                                                    <i
                                                                        className="flaticon2-pie-chart-2 kt-font-success" />
                                                                </div>
                                                                <div className="kt-notification__item-details">
                                                                    <div className="kt-notification__item-title">
                                                            ...
                                                            <a href="#" className="kt-notification__item">
                                                                <div className="kt-notification__item-icon">
                                                                    <i
                                                                        className="flaticon2-pie-chart kt-font-success" />
                                                                </div>
                                                                <div className="kt-notification__item-details">
                                                                    <div className="kt-notification__item-title">
                                                                        New customer is registered
                                                    ...
                                                    <div className="tab-pane" id="topbar_notifications_logs"
                                                        role="tabpanel">
                                                        <div className="kt-grid kt-grid--ver" style={{minHeight: 200}}>
                                                            <div
                                                ...
                                                <svg xmlns="http://www.w3.org/2000/svg"
                                                    ...
                                                    <g stroke="none" strokeWidth={1} fill="none" fillRule="evenodd">
                                                        ...
                                                        <path
                                                            ...
                                                            id="Path-30" fill="#000000" fillRule="nonzero"
                                                            opacity="0.3" />
                                                        <path
                                        ...
                                        <div
                                            ...
                                            <form>
                                                ...
                                                <div className="kt-mycart">
                                                    ...
                                                    <div className="kt-mycart__body kt-scroll" data-scroll="true"
                                                            ...
                                                            <div className="kt-mycart__container">
                                                                <div className="kt-mycart__info">
                                                                    ...
                                                                    <div className="kt-mycart__action">
                                                                        ...
                                                                        <a href="#"
                                                                            className="btn btn-label-success btn-icon">−</a>
                                                                        <a href="#"
                                                                            className="btn btn-label-success btn-icon">+</a>
                                                                    </div>
                                                                </div>
                                                    ...
                                                    <div className="kt-mycart__footer">
                                                        ...
                                                        <div className="kt-mycart__button kt-align-right">
                                                            <button type="button"
                                                                className="btn btn-primary btn-sm">Place Order</button>
                                                        </div>
                                                    </div>
                                                </div>
                                                {/* end:: Mycart */}
                                    ...
                                    <div className="kt-header__topbar-item kt-header__topbar-item--user">
                                        <div className="kt-header__topbar-wrapper" data-toggle="dropdown"
                                            ...
                                            <div className="kt-header__topbar-user">
                                                ...
                                                <span
                                                    className="kt-header__topbar-username kt-hidden-mobile">Sean</span>
                                                <img className="kt-hidden" alt="Pic"
                                                    src="./assets/media/users/300_25.jpg" />
                                                {/*use below badge element instead the user avatar to display username's
                                                first letter(remove kt-hidden class to display it) */}
                                                <span
                                            ...
                                            <div className="kt-notification">
                                                ...
                                                <div className="kt-notification__custom kt-space-between">
                                                    <a href="demo1/custom/user/login-v2.html" target="_blank"
                                                        className="btn btn-label btn-label-brand btn-sm btn-bold">Sign
                                                        Out</a>
                                                    <a href="demo1/custom/user/login-v2.html" target="_blank"
                            ...
                            <div className="kt-grid__item kt-grid__item--fluid kt-grid kt-grid--hor">
                                ...
                                <div className="kt-subheader   kt-grid__item" id="kt_subheader">
                                    <div className="kt-subheader__main">
                                        ...
                                        <div
                                            className="kt-input-icon kt-input-icon--right kt-subheader__search kt-hidden">
                                        ...
                                        <div className="kt-subheader__wrapper">
                                            ...
                                            <a href="#" className="btn kt-subheader__btn-primary">
                                                ...
                                                <svg xmlns="http://www.w3.org/2000/svg"
                                                    ...
                                                    <g stroke="none" strokeWidth={1} fill="none" fillRule="evenodd">
                                                        <rect id="bound" x={0} y={0} width={24} height={24} />
                                                        <rect id="Rectangle-8" fill="#000000" x={4} y={5} width={16}
                                                            height={3} rx="1.5" />
                                                        <path
                                            ...
                                            <div className="dropdown dropdown-inline" data-toggle-="kt-tooltip"
                                                title="Quick actions" data-placement="left">
                                                <a href="#" className="btn btn-icon" data-toggle="dropdown"
                                                        ...
                                                        <li className="kt-nav__item">
                                                            <a href="#" className="kt-nav__link">
                                                                ...
                                                                <span className="kt-nav__link-badge">
                                                                    <span
                                                                        className="kt-badge kt-badge--brand kt-badge--rounded">5</span>
                                                                </span>
                                                            </a>
                                                        </li>
                                                        <li className="kt-nav__separator" />
                                                        <li className="kt-nav__foot">
                                                            <a className="btn btn-label-brand btn-bold btn-sm"
                                                                href="#">Upgrade plan</a>
                                                            <a className="btn btn-clean btn-bold btn-sm kt-hidden"
                                                                href="#" data-toggle="kt-tooltip" data-placement="right"
                                ...
                                <div className="kt-content  kt-grid__item kt-grid__item--fluid" id="kt_content">
                                    ...
                                    <div className="row">
                                        <div className="col-xl-4">
                                            ...
                                            <div
                                                className="kt-portlet kt-portlet--fit kt-portlet--head-lg kt-portlet--head-overlay kt-portlet--skin-solid kt-portlet--height-fluid">
                                                <div
                                                    className="kt-portlet__head kt-portlet__head--noborder kt-portlet__space-x">
                                                    ...
                                                    <div className="kt-portlet__head-toolbar">
                                                        <a href="#"
                                                            className="btn btn-label-light btn-sm btn-bold dropdown-toggle"
                                                        ...
                                                        <div
                                                            ...
                                                            <ul className="kt-nav">
                                                                <li className="kt-nav__section kt-nav__section--first">
                                                                    <span
                                                                        className="kt-nav__section-text">Finance</span>
                                                                </li>
                                                                <li className="kt-nav__item">
                                                                    <a href="#" className="kt-nav__link">
                                                                        <i
                                                                            className="kt-nav__link-icon flaticon2-graph-1" />
                                                                        <span
                                                                            className="kt-nav__link-text">Statistics</span>
                                                                    </a>
                                                                </li>
                                                                <li className="kt-nav__item">
                                                                    <a href="#" className="kt-nav__link">
                                                                        <i
                                                                            className="kt-nav__link-icon flaticon2-calendar-4" />
                                                                        <span
                                                                            className="kt-nav__link-text">Events</span>
                                                                    </a>
                                                                </li>
                                                                <li className="kt-nav__item">
                                                                    <a href="#" className="kt-nav__link">
                                                                        <i
                                                                            className="kt-nav__link-icon flaticon2-layers-1" />
                                                                        <span
                                                                            className="kt-nav__link-text">Reports</span>
                                                                    </a>
                                                                </li>
                                                                <li className="kt-nav__section kt-nav__section--first">
                                                                ...
                                                                <li className="kt-nav__item">
                                                                    <a href="#" className="kt-nav__link">
                                                                        <i
                                                                            className="kt-nav__link-icon flaticon2-calendar-4" />
                                                                        <span
                                                                            className="kt-nav__link-text">Notifications</span>
                                                                    </a>
                                                                </li>
                                                                <li className="kt-nav__item">
                                                                    <a href="#" className="kt-nav__link">
                                                                        <i
                                                                            className="kt-nav__link-icon flaticon2-file-1" />
                                                ...
                                                <div className="kt-portlet__body kt-portlet__body--fit">
                                                    <div className="kt-widget17">
                                                        <div className="kt-widget17__visual kt-widget17__visual--chart kt-portlet-fit--top kt-portlet-fit--sides"
                                                            style={{backgroundColor: '#fd397a'}}>
                                                            <div className="kt-widget17__chart" style={{height: 320}}>
                                        ...
                                        <div className="col-xl-4">
                                            ...
                                            <div
                                                className="kt-portlet kt-portlet--fit kt-portlet--head-noborder kt-portlet--height-fluid-half">
                                                        ...
                                                        <div
                                                            ...
                                                            <ul className="kt-nav">
                                                                <li className="kt-nav__item">
                                                                    <a href="#" className="kt-nav__link">
                                                                        <i
                                                                            className="kt-nav__link-icon flaticon2-line-chart" />
                                                                        <span
                                                                            className="kt-nav__link-text">Reports</span>
                                                                    </a>
                                                                </li>
                                                                <li className="kt-nav__item">
                                                                    <a href="#" className="kt-nav__link">
                                                                        <i
                                                                            className="kt-nav__link-icon flaticon2-send" />
                                                                        <span
                                                                            className="kt-nav__link-text">Messages</span>
                                                                    </a>
                                                                </li>
                                                                <li className="kt-nav__item">
                                                                    <a href="#" className="kt-nav__link">
                                                                        <i
                                                                            className="kt-nav__link-icon flaticon2-pie-chart-1" />
                                                                        <span
                                                                            className="kt-nav__link-text">Charts</span>
                                                                    </a>
                                                                </li>
                                                                <li className="kt-nav__item">
                                                                    <a href="#" className="kt-nav__link">
                                                                        <i
                                                                            className="kt-nav__link-icon flaticon2-avatar" />
                                                                        <span
                                                                            className="kt-nav__link-text">Members</span>
                                                                    </a>
                                                                </li>
                                                                <li className="kt-nav__item">
                                                                    <a href="#" className="kt-nav__link">
                                                                        <i
                                                                            className="kt-nav__link-icon flaticon2-settings" />
                                                                        <span
                                                                            className="kt-nav__link-text">Settings</span>
                                                                    </a>
                                                                </li>
                                                            </ul>
                                                        </div>
                                                ...
                                                <div className="kt-portlet__body kt-portlet__body--fluid">
                                                    <div className="kt-widget20">
                                                        <div className="kt-widget20__content kt-portlet__space-x">
                                                            <span
                                                                className="kt-widget20__number kt-font-brand">670+</span>
                                                            <span className="kt-widget20__desc">Successful
                                                                transactions</span>
                                                        </div>
                                                        <div className="kt-widget20__chart" style={{height: 130}}>
                                                            <canvas id="kt_chart_bandwidth1" />
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div
                                                ...
                                                <div className="kt-portlet__head kt-portlet__space-x">
                                                    ...
                                                    <div className="kt-portlet__head-toolbar">
                                                        <a href="#"
                                                            className="btn btn-label-warning btn-sm  btn-bold dropdown-toggle"
                                                            data-toggle="dropdown">
                                                            Download
                                                        </a>
                                                        <div
                                                ...
                                                <div className="kt-portlet__body kt-portlet__body--fluid">
                                                    <div className="kt-widget20">
                                                        <div className="kt-widget20__content kt-portlet__space-x">
                                                            <span
                                                                className="kt-widget20__number kt-font-danger">1340+</span>
                                                            <span className="kt-widget20__desc">Completed orders</span>
                                                        </div>
                                                        <div className="kt-widget20__chart" style={{height: 130}}>
                                                            <canvas id="kt_chart_bandwidth2" />
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                                ...
                                                <div className="kt-portlet__head">
                                                    ...
                                                    <div className="kt-portlet__head-toolbar">
                                                        <div className="dropdown dropdown-inline">
                                                            ...
                                                            <div
                                                                className="dropdown-menu dropdown-menu-right dropdown-menu-fit dropdown-menu-md">
                                                                {/*begin::Nav*/}
                                                                <ul className="kt-nav">
                                                                    <li className="kt-nav__head">
                                                                        Export Options
                                                                    ...
                                                                    <li className="kt-nav__item">
                                                                        <a href="#" className="kt-nav__link">
                                                                            <i
                                                                                className="kt-nav__link-icon flaticon2-drop" />
                                                                            <span
                                                                                className="kt-nav__link-text">Activity</span>
                                                                        </a>
                                                                    </li>
                                                                    <li className="kt-nav__item">
                                                                        <a href="#" className="kt-nav__link">
                                                                            <i
                                                                                className="kt-nav__link-icon flaticon2-calendar-8" />
                                                                            <span
                                                                                className="kt-nav__link-text">FAQ</span>
                                                                        </a>
                                                                    </li>
                                                                    <li className="kt-nav__item">
                                                                        <a href="#" className="kt-nav__link">
                                                                            <i
                                                                                className="kt-nav__link-icon flaticon2-link" />
                                                                            <span
                                                                                className="kt-nav__link-text">Settings</span>
                                                                        </a>
                                                                    </li>
                                                                    <li className="kt-nav__item">
                                                                        <a href="#" className="kt-nav__link">
                                                                            <i
                                                                                className="kt-nav__link-icon flaticon2-new-email" />
                                                                            <span
                                                                                className="kt-nav__link-text">Support</span>
                                                                            <span className="kt-nav__link-badge">
                                                                                <span
                                                                    ...
                                                                    <li className="kt-nav__separator" />
                                                                    <li className="kt-nav__foot">
                                                                        <a className="btn btn-label-danger btn-bold btn-sm"
                                                                            href="#">Upgrade plan</a>
                                                                        <a className="btn btn-clean btn-bold btn-sm"
                                                    ...
                                                    <div className="kt-timeline-v2">
                                                        <div
                                                            ...
                                                            <div className="kt-timeline-v2__item">
                                                                ...
                                                                <div
                                                                    className="kt-timeline-v2__item-text kt-timeline-v2__item-text--bold">
                                                                    AEOL Meeting With
                                                                </div>
                                                                <div
                                                                    className="kt-list-pics kt-list-pics--sm kt-padding-l-20">
                                                                    <a href="#"><img
                                                            ...
                                                            <div className="kt-timeline-v2__item">
                                                                ...
                                                                <div
                                                                    className="kt-timeline-v2__item-text kt-padding-top-5">
                                                                    Make Deposit <a href="#"
                                                                        className="kt-link kt-link--brand kt-font-bolder">USD
                                                                        700</a> To ESL.
                                                                </div>
                                                            </div>
                                                            <div className="kt-timeline-v2__item">
                                                                ...
                                                                <div className="kt-timeline-v2__item-cricle">
                                                                    <i className="fa fa-genderless kt-font-warning" />
                                                                </div>
                                                                <div
                                                                    className="kt-timeline-v2__item-text kt-padding-top-5">
                                                                    Lorem ipsum dolor sit amit,consectetur eiusmdd
                                                            ...
                                                            <div className="kt-timeline-v2__item">
                                                                ...
                                                                <div
                                                                    ...
                                                                    Placed a new order in <a href="#"
                                                                        className="kt-link kt-link--brand kt-font-bolder">SIGNATURE
                                                            ...
                                                            <div className="kt-timeline-v2__item">
                                                                ...
                                                                <div
                                                                    ...
                                                                    Received a new feedback on <a href="#"
                                                                        className="kt-link kt-link--brand kt-font-bolder">FinancePro
                                                                        App</a> product.
                                                                </div>
                                                            </div>
                                                            <div className="kt-timeline-v2__item">
                                                                <span className="kt-timeline-v2__item-time">15:30</span>
                                                                <div className="kt-timeline-v2__item-cricle">
                                                                    <i className="fa fa-genderless kt-font-danger" />
                                                                </div>
                                                                <div
                                                                    className="kt-timeline-v2__item-text kt-padding-top-5">
                                                                    New notification message has been received on <a
                                                                        href="#"
                                                                        className="kt-link kt-link--brand kt-font-bolder">LoopFin
                                                                        Pro</a> product.
                                                                </div>
                                                            </div>
                                                        </div>
                                    ...
                                    <div className="row">
                                        <div className="col-xl-8">
                                            <div className="kt-portlet kt-portlet--height-fluid kt-portlet--mobile ">
                                                <div
                                                    className="kt-portlet__head kt-portlet__head--lg kt-portlet__head--noborder kt-portlet__head--break-sm">
                                                    <div className="kt-portlet__head-label">
                                                        <h3 className="kt-portlet__head-title">
                                                    ...
                                                    <div className="kt-portlet__head-toolbar">
                                                        <div className="dropdown dropdown-inline">
                                                            ...
                                                            <div
                                                                className="dropdown-menu dropdown-menu-right dropdown-menu-md dropdown-menu-fit">
                                                                {/*begin::Nav*/}
                                                                <ul className="kt-nav">
                                                                    <li className="kt-nav__head">
                                                                        Export Options
                                                ...
                                                <div className="kt-portlet__body kt-portlet__body--fit">
                                                    {/*begin: Datatable */}
                                                    <div className="kt-datatable" id="kt_datatable_latest_orders" />
                                                    {/*end: Datatable */}
                                                </div>
                                            </div>
                                        </div>
                                        <div className="col-xl-4">
                                            ...
                                            <div className="kt-portlet kt-portlet--height-fluid kt-widget19">
                                                <div
                                                    className="kt-portlet__body kt-portlet__body--fit kt-portlet__body--unfill">
                                                    <div className="kt-widget19__pic kt-portlet-fit--top kt-portlet-fit--sides"
                                                        style={{minHeight: 300, backgroundImage: 'url(./assets/media//products/product4.jpg)'}}>
                                                        <h3 className="kt-widget19__title kt-font-light">
                                                            Introducing New Feature
                                                        </h3>
                                                        <div className="kt-widget19__shadow" />
                                                        <div className="kt-widget19__labels">
                                                            <a href="#"
                                                                className="btn btn-label-light-o2 btn-bold btn-sm ">Recent</a>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div className="kt-portlet__body">
                                                    <div className="kt-widget19__wrapper">
                                                        <div className="kt-widget19__content">
                                                            ...
                                                            <div className="kt-widget19__stats">
                                                                ...
                                                                <a href="#" className="kt-widget19__comment">
                                                                    Comments
                                                                </a>
                                                            </div>
                                                        </div>
                                                        <div className="kt-widget19__text">
                                                            ...
                                                            typesetting scrambled a type specimen book text of the dummy
                                                            text of the printing printing and typesetting industry
                                                            scrambled dummy text of the printing.
                                                        </div>
                                                    </div>
                                                    <div className="kt-widget19__action">
                                                        <a href="#" className="btn btn-sm btn-label-brand btn-bold">Read
                                                            More...</a>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div className="col-xl-8">
                                            ...
                                            <div className="kt-portlet kt-portlet--height-fluid">
                                                <div className="kt-portlet__head">
                                                    ...
                                                    <div className="kt-portlet__head-toolbar">
                                                        <ul className="nav nav-pills nav-pills-sm nav-pills-label nav-pills-bold"
                                                            role="tablist">
                                                            <li className="nav-item">
                                                ...
                                                <div className="kt-portlet__body">
                                                    <div className="tab-content">
                                                        <div className="tab-pane active" id="kt_widget5_tab1_content"
                                                            aria-expanded="true">
                                                            <div className="kt-widget5">
                                                                    ...
                                                                    <div className="kt-widget5__content">
                                                                        ...
                                                                        <div className="kt-widget5__section">
                                                                            ...
                                                                            <div className="kt-widget5__info">
                                                                                <span>Author:</span>
                                                                                <span
                                                                                    className="kt-font-info">Keenthemes</span>
                                                                                <span>Released:</span>
                                                                                <span
                                                                                    className="kt-font-info">23.08.17</span>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                    <div className="kt-widget5__content">
                                                                        <div className="kt-widget5__stats">
                                                                            <span
                                                                                className="kt-widget5__number">19,200</span>
                                                                            <span
                                                                                className="kt-widget5__sales">sales</span>
                                                                        </div>
                                                                        <div className="kt-widget5__stats">
                                                                            <span
                                                                                className="kt-widget5__number">1046</span>
                                                                            <span
                                                                                className="kt-widget5__votes">votes</span>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                                <div className="kt-widget5__item">
                                                                    <div className="kt-widget5__content">
                                                                        ...
                                                                        <div className="kt-widget5__section">
                                                                            ...
                                                                            <div className="kt-widget5__info">
                                                                                <span>Author:</span>
                                                                                <span className="kt-font-info">Fly
                                                                                    themes</span>
                                                                                <span>Released:</span>
                                                                                <span
                                                                                    className="kt-font-info">23.08.17</span>
                                                                    ...
                                                                    <div className="kt-widget5__content">
                                                                        <div className="kt-widget5__stats">
                                                                            <span
                                                                                className="kt-widget5__number">24,583</span>
                                                                            <span
                                                                                className="kt-widget5__sales">sales</span>
                                                                        </div>
                                                                        <div className="kt-widget5__stats">
                                                                            <span
                                                                                className="kt-widget5__number">3809</span>
                                                                            <span
                                                                                className="kt-widget5__votes">votes</span>
                                                                        </div>
                                                                    </div>
                                                                ...
                                                                <div className="kt-widget5__item">
                                                                    ...
                                                                    <div className="kt-widget5__content">
                                                                        <div className="kt-widget5__stats">
                                                                            <span
                                                                                className="kt-widget5__number">210,054</span>
                                                                            <span
                                                                                className="kt-widget5__sales">sales</span>
                                                                        </div>
                                                                        <div className="kt-widget5__stats">
                                                                            <span
                                                                                className="kt-widget5__number">1103</span>
                                                                            <span
                                                                                className="kt-widget5__votes">votes</span>
                                                                        </div>
                                                                    </div>
                                                        ...
                                                        <div className="tab-pane active" id="kt_widget4_tab1_content">
                                                            <div className="kt-widget4">
                                                                <div className="kt-widget4__item">
                                                                    ...
                                                                    <a href="#"
                                                                        className="btn btn-sm btn-label-brand btn-bold">Follow</a>
                                                                </div>
                                                                <div className="kt-widget4__item">
                                                                    <div
                                                                        className="kt-widget4__pic kt-widget4__pic--pic">
                                                                    ...
                                                                    <a href="#"
                                                                        className="btn btn-sm btn-label-warning btn-bold">Follow</a>
                                                                </div>
                                                                <div className="kt-widget4__item">
                                                                    <div
                                                                        className="kt-widget4__pic kt-widget4__pic--pic">
                                                                    ...
                                                                    <a href="#"
                                                                        className="btn btn-sm btn-label-danger btn-bold">Follow</a>
                                                                </div>
                                                                <div className="kt-widget4__item">
                                                                    <div
                                                                        className="kt-widget4__pic kt-widget4__pic--pic">
                                                                    ...
                                                                    <a href="#"
                                                                        className="btn btn-sm btn-label-success btn-bold">Follow</a>
                                                                </div>
                                                                <div className="kt-widget4__item">
                                                                    <div
                                                                        className="kt-widget4__pic kt-widget4__pic--pic">
                                                                    ...
                                                                    <a href="#"
                                                                        className="btn btn-sm btn-label-primary btn-bold">Follow</a>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div className="tab-pane" id="kt_widget4_tab2_content">
                                                            <div className="kt-widget4">
                                                                <div className="kt-widget4__item">
                                                                    ...
                                                                    <a href="#"
                                                                        className="btn btn-sm btn-label-success">Follow</a>
                                                                </div>
                                                                <div className="kt-widget4__item">
                                                                    <div
                                                                        className="kt-widget4__pic kt-widget4__pic--pic">
                                                                    ...
                                                                    <a href="#"
                                                                        className="btn btn-sm btn-label-brand">Follow</a>
                                                                </div>
                                                                <div className="kt-widget4__item">
                                                                    <div
                                                                        className="kt-widget4__pic kt-widget4__pic--pic">
                                                                    ...
                                                                    <a href="#"
                                                                        className="btn btn-sm btn-label-danger">Follow</a>
                                                                </div>
                                                                <div className="kt-widget4__item">
                                                                    <div
                                                                        className="kt-widget4__pic kt-widget4__pic--pic">
                                                                ...
                                                                <div className="kt-widget4__item">
                                                                    ...
                                                                    <a href="#"
                                                                        className="btn btn-sm btn-label-info">Follow</a>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                        ...
                                        <div className="col-xl-4">
                                            ...
                                            <div className="kt-portlet kt-portlet--height-fluid">
                                                <div className="kt-widget14">
                                                    ...
                                                    <div className="kt-widget14__chart" style={{height: 120}}>
                                                    ...
                                                    <div className="kt-widget14__content">
                                                        ...
                                                        <div className="kt-widget14__legends">
                                                            <div className="kt-widget14__legend">
                                                                <span className="kt-widget14__bullet kt-bg-success" />
                                                                <span className="kt-widget14__stats">37% Sport
                                                                    Tickets</span>
                                                            </div>
                                                            <div className="kt-widget14__legend">
                                                                <span className="kt-widget14__bullet kt-bg-warning" />
                                                                <span className="kt-widget14__stats">47% Business
                                                                    Events</span>
                                                            </div>
                                                            <div className="kt-widget14__legend">
                                                                <span className="kt-widget14__bullet kt-bg-brand" />
                                                ...
                                                <div className="kt-widget14">
                                                    ...
                                                    <div className="kt-widget14__content">
                                                        ...
                                                        <div className="kt-widget14__legends">
                                                            <div className="kt-widget14__legend">
                                                                <span className="kt-widget14__bullet kt-bg-success" />
                                                                <span className="kt-widget14__stats">+10% New
                                                                    York</span>
                                                            </div>
                                                            <div className="kt-widget14__legend">
                                                                <span className="kt-widget14__bullet kt-bg-warning" />
                                                            ...
                                                            <div className="kt-widget14__legend">
                                                                <span className="kt-widget14__bullet kt-bg-brand" />
                                                                <span className="kt-widget14__stats">+20%
                                                                    California</span>
                                                            </div>
                                                        </div>
                                                    </div>
                                    ...
                                    <div className="row">
                                                    ...
                                                    <div className="tab-content">
                                                        <div className="tab-pane active" id="kt_widget2_tab1_content">
                                                            <div className="kt-widget2">
                                                                <div
                                                                    className="kt-widget2__item kt-widget2__item--primary">
                                                                    <div className="kt-widget2__checkbox">
                                                                        <label
                                                                            className="kt-checkbox kt-checkbox--solid kt-checkbox--single">
                                                                            <input type="checkbox" />
                                                                            <span />
                                                                        </label>
                                                                    </div>
                                                                    <div className="kt-widget2__info">
                                                                        ...
                                                                        <a href="#" className="kt-widget2__username">
                                                                            By Bob
                                                                        </a>
                                                                    </div>
                                                                ...
                                                                <div
                                                                    className="kt-widget2__item kt-widget2__item--warning">
                                                                    <div className="kt-widget2__checkbox">
                                                                        <label
                                                                            className="kt-checkbox kt-checkbox--solid kt-checkbox--single">
                                                                            <input type="checkbox" />
                                                                ...
                                                                <div
                                                                    className="kt-widget2__item kt-widget2__item--brand">
                                                                    <div className="kt-widget2__checkbox">
                                                                        <label
                                                                            className="kt-checkbox kt-checkbox--solid kt-checkbox--single">
                                                                            <input type="checkbox" />
                                                                    ...
                                                                    <div className="kt-widget2__info">
                                                                        <a href="#" className="kt-widget2__title">
                                                                            Make Widgets Great Again.Estudiat Communy
                                                                            Elit
                                                                        </a>
                                                                        <a href="#" className="kt-widget2__username">
                                                                            By Aziko
                                                                ...
                                                                <div
                                                                    className="kt-widget2__item kt-widget2__item--success">
                                                                    <div className="kt-widget2__checkbox">
                                                                        <label
                                                                            className="kt-checkbox kt-checkbox--solid kt-checkbox--single">
                                                                            <input type="checkbox" />
                                                                ...
                                                                <div
                                                                    className="kt-widget2__item kt-widget2__item--danger">
                                                                    <div className="kt-widget2__checkbox">
                                                                        <label
                                                                            className="kt-checkbox kt-checkbox--solid kt-checkbox--single">
                                                                            <input type="checkbox" />
                                                                    ...
                                                                    <div className="kt-widget2__info">
                                                                        <a href="#" className="kt-widget2__title">
                                                                            Completa Financial Report For Emirates
                                                                            Airlines
                                                                        </a>
                                                                        <a href="#" className="kt-widget2__username">
                                                                            By Bob
                                                                ...
                                                                <div
                                                                    className="kt-widget2__item kt-widget2__item--info">
                                                                    <div className="kt-widget2__checkbox">
                                                                        <label
                                                                            className="kt-checkbox kt-checkbox--solid kt-checkbox--single">
                                                                            <input type="checkbox" />
                                                                    ...
                                                                    <div className="kt-widget2__info">
                                                                        <a href="#" className="kt-widget2__title">
                                                                            ...
                                                                            className="kt-widget2__username">
                                                                            By Sean
                                                                        </a>
                                                                    </div>
                                                                    <div className="kt-widget2__actions">
                                                        ...
                                                        <div className="tab-pane" id="kt_widget2_tab3_content">
                                                            <div className="kt-widget2">
                                                                <div
                                                                    className="kt-widget2__item kt-widget2__item--warning">
                                                                    <div className="kt-widget2__checkbox">
                                        ...
                                        <div className="col-xl-4">
                                            ...
                                            <div className="kt-portlet kt-portlet--height-fluid">
                                                ...
                                                <div className="kt-portlet__body">
                                                    <div className="tab-content">
                                                        <div className="tab-pane active" id="kt_widget6_tab1_content"
                                                            aria-expanded="true">
                                                            <div className="kt-notification">
                                                                <a href="#" className="kt-notification__item">
                                                                    <div className="kt-notification__item-icon">
                                                        ...
                                                        <div className="tab-pane" id="kt_widget6_tab2_content"
                                                            aria-expanded="false">
                                                            <div className="kt-notification">
                                                                <a href="#" className="kt-notification__item">
                                                                    <div className="kt-notification__item-icon">
                                                                        ...
                                                                        <svg xmlns="http://www.w3.org/2000/svg"
                                                                            ...
                                                                            <g stroke="none" strokeWidth={1} fill="none"
                                                                                ...
                                                                                <rect id="Rectangle-62-Copy"
                                                                                    fill="#000000" opacity="0.3" x={12}
                                                                                    y={4} width={3} height={13}
                                                                                    rx="1.5" />
                                                                                <rect id="Rectangle-62-Copy-2"
                                                                                    fill="#000000" opacity="0.3" x={7}
                                                                ...
                                                                <a href="#" className="kt-notification__item">
                                                                    <div className="kt-notification__item-icon">
                                                                        <svg xmlns="http://www.w3.org/2000/svg"
                                                                            ...
                                                                            width="24px" height="24px"
                                                                            viewBox="0 0 24 24" version="1.1"
                                                                            className="kt-svg-icon kt-svg-icon--info">
                                                                            <g stroke="none" strokeWidth={1} fill="none"
                                                                                fillRule="evenodd">
                                                                                <polygon id="Shape"
                                                                                    points="0 0 24 0 24 24 0 24" />
                                                        ...
                                                        <div className="tab-pane" id="kt_widget6_tab3_content"
                                                            aria-expanded="false">
                                                            <div className="kt-notification">
                                                                <a href="#" className="kt-notification__item">
                                                                    <div className="kt-notification__item-icon">
                                                                        ...
                                                                        <svg xmlns="http://www.w3.org/2000/svg"
                                                                            ...
                                                                            <g stroke="none" strokeWidth={1} fill="none"
                                                                                ...
                                                                                <rect id="Combined-Shape" fill="#000000"
                                                                                    opacity="0.3" x={2} y={9} width={20}
                                                                                    height={13} rx={2} />
                                                                                <rect id="Rectangle-116-Copy"
                                                                                    fill="#000000" opacity="0.3" x={5}
                                                                                    y={5} width={14} height={2}
                                                                                    rx="0.5" />
                                                                                <rect id="Rectangle-116-Copy-2"
                                                                                    fill="#000000" opacity="0.3" x={7}
                                                                                    y={1} width={10} height={2}
                                                                                    rx="0.5" />
                                                                                <path
                                                                ...
                                                                <a href="#" className="kt-notification__item">
                                                                    <div className="kt-notification__item-icon">
                                                                        <svg xmlns="http://www.w3.org/2000/svg"
                                                                            ...
                                                                            <g stroke="none" strokeWidth={1} fill="none"
                                                                                fillRule="evenodd">
                                                                                <rect id="Bound" opacity="0.200000003"
                                                                                    x={0} y={0} width={24}
                                                                                    height={24} />
                                                                                <path
                                            ...
                                            <div className="kt-portlet kt-portlet--height-fluid">
                                                <div className="kt-portlet__head">
                                                    ...
                                                    <div className="kt-portlet__head-toolbar">
                                                        <div className="dropdown dropdown-inline">
                                                            <button type="button"
                                                                className="btn btn-clean btn-sm btn-icon-md btn-icon"
                                                                data-toggle="dropdown" aria-haspopup="true"
                                                                aria-expanded="false">
                                                                <i className="flaticon-more-1" />
                                                            </button>
